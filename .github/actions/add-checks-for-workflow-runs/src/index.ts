/**
 * Why this exists in your pipeline
 *
 * A workflow_run workflow doesn't naturally show up as a required PR
 * check in the same clean way a pull_request workflow does.
 * This action forces a stable, named check ("Deploy Preview to Vercel")
 * to exist on the PR's head commit so you can require it in branch
 * protection and get a single green/red gate that summarizes "CI
