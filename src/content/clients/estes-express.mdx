...
- Executed four-phase approach (non-critical systems → database migration and interim VM deployment → .NET 8 / Angular modernization → final cutover) that built team Azure competency before touching customer-facing systems
