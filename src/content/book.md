...
- 
  ...
  - ![fa fa-calendar](https://cbaeanlyhvvsolskilxw.supabase.co/storage/v1/object/public/assets/calendar.svg)

    Live session - Module 1: Intro to platform engineering

  - ![icon-video](https://cbaeanlyhvvsolskilxw.supabase.co/storage/v1/object/public/assets/play.svg)

    Recording - Live session - Module 1: Intro to platform engineering

  - ![fa fa-check-square-o](https://cbaeanlyhvvsolskilxw.supabase.co/storage/v1/object/public/assets/circle-check.svg)

    Quiz - Module 1: Intro to platform engineering

  - ![icon-text](https://cbaeanlyhvvsolskilxw.supabase.co/storage/v1/object/public/assets/document.svg)
