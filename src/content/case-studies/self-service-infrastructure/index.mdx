...
<Table
  ...
  content={{
    figure: 'Table: Infrastructure request distribution by resource type',
    thead: {
...
<List
  ...
  items={[
    {
      text: 'Engineer creates a branch in their team\'s infrastructure repo',
    },
    {
      text: 'Adds or modifies Terraform configuration using approved modules',
    },
    {
      text: 'Opens a PR',
    },
    {
      text: 'GitHub Actions runs <span class="font-mono">terraform plan</span>, OPA policy checks, and Infracost',
    },
    {
      text: 'PR comment shows the plan, any policy violations, and cost estimate',
    },
    {
      text: 'For standard patterns, engineer merges after self-review',
    },
    {
      text: 'Atlantis applies the changes automatically',
    },
    {
      text: 'Resources are provisioned, tagged, and compliant',
    },
  ]}
/>
...
<Table
  variant="striped-rows-table"
  content={{
    figure: 'Table: Self-service infrastructure outcomes',
    thead: {
