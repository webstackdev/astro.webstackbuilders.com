...
<Table
  ...
  content={{
    figure: 'Table: Zero trust implementation phases',
    thead: {
    ...
    tbody: {
      tr: [
        {
          td: ['1: Mesh Installation', 'Install Istio sidecars in permissive mode; mTLS available but not required', 'Low'],
        },
        {
          td: ['2: Observability', 'Gain visibility via Kiali; map which services communicate and mTLS coverage', 'Low'],
        },
        {
          td: ['3: Policy Definition', 'Define authorization policies based on observed patterns; audit mode first', 'Medium'],
        },
        {
          td: ['4: Strict Mode', 'Enable mTLS strict mode; flip policies from audit to enforce', 'High'],
        },
      ],
    },
  }}
...
<Table
  variant="striped-rows-table"
  content={{
    figure: 'Table: Zero trust implementation outcomes',
    thead: {
