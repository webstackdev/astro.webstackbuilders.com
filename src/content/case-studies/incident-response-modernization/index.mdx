...
<List
  ...
  items={[
    {
      text: 'Alerts deduplicated and grouped to reduce noise',
    },
    {
      text: 'Escalation policies that actually escalated',
    },
    {
      text: 'On-call schedules visible to everyone',
    },
    {
      text: 'Automatic Slack channel creation for incidents',
    },
  ]}
/>
