...
<List
  ...
  items={[
    {
      text: 'Engineer opens PR with Terraform changes',
    },
    {
      text: 'Atlantis automatically runs <span class="font-mono">terraform plan</span> and comments the output on the PR',
    },
    {
      text: 'Reviewer checks the plan, approves if correct',
    },
    {
      text: 'Engineer comments <span class="font-mono">atlantis apply</span> to execute',
    },
    {
      text: 'Atlantis applies changes and comments the result',
    },
  ]}
/>
...
<Table
  variant="striped-rows-table"
  content={{
    figure: 'Table: Transformation outcomes',
    thead: {
...
<List
  ...
  items={[
    ...
    },
    {
      ...
      text: 'With all changes going through PRs, environments stayed in sync. The "works in staging, fails in production" problem disappeared.',
    },
    {
...
<List
  ...
  items={[
    ...
    },
    {
      ...
      text: 'Once all changes required a PR, the "quick fix in the console" pattern stopped. Engineers adapted because the new process was actually easier, running <span class="font-mono">atlantis apply</span> is less work than clicking through the console, and rollback is trivial.',
    },
  ]}
/>
