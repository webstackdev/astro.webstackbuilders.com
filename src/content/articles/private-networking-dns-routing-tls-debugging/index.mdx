---
title: "Why Moving to Private Networking Broke Everything"
...
<Highlighter>Private networking isn't "the same thing, but internal." It's a fundamentally different debugging domain where familiar tools give unfamiliar results and "connection refused" could mean six different things depending on which layer actually failed.</Highlighter> The trick is knowing where to look.
...
<Table
  ...
  content={{
    thead: {
      th: ['Layer', 'What to Check', 'Command', 'Pass Criteria'],
    },
    tbody: {
      tr: [
        {
          th: 'DNS',
          td: [
            'Does the name resolve to the expected private IP?',
            '<span class="font-mono">getent hosts \<hostname\></span> (sees what your app sees) or <span class="font-mono">dig @\<vpc-resolver\></span> (bypasses cache)',
        ...
        },
        {
          ...
          td: [
            ...
            '<span class="font-mono">ip route get \<ip\></span>',
        ...
        },
        {
          ...
          td: [
            ...
            '<span class="font-mono">nc -zv -w 5 \<ip\> \<port\></span>',
        ...
        },
        {
          ...
          td: [
            ...
            '<span class="font-mono">openssl s_client -connect \<ip\>:\<port\> -servername \<hostname\></span>',
            'Certificate chain valid, hostname matches SAN',
          ],
        },
        {
          th: 'Application',
          td: ['Do credentials and allowlists pass?', 'Check application logs', 'Authenticated successfully'],
        },
      ],
    },
      ...
      tr: [
        {
          ...
          td: ['Using public DNS or private zone not associated', 'Configure VPC resolver, associate zone'],
        },
        {
          th: 'NXDOMAIN for private endpoint',
          td: ['Zone not associated with source VPC', 'Associate zone with VPC'],
        },
        {
          th: 'Same name resolves differently in different places',
          td: ['Split-horizon misconfiguration', 'Verify zone associations across all VPCs'],
        },
        {
          th: 'Old IP returned after endpoint change',
          td: ['DNS caching with high TTL', 'Lower TTL before migrations, flush caches'],
        },
      ],
    },
