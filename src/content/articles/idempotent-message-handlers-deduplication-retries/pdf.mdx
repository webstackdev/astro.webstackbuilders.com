...
/>
  ...
  <Diagram
    title="Message delivery semantics - at-most-once risks loss, at-least-once risks duplicates, exactly-once requires idempotent handlers."
...
<Diagram
  title="Transactional outbox - state change and event written atomically, publisher polls outbox."
...
>
  ```mermaid
  flowchart LR
      subgraph singleTransaction[Single Transaction]
