...
import flakyTestDiagram from "./diagrams/flaky-test-quarantine-workflow.png"
import timelineDiagram from "./diagrams/timeline-showing-race-condition.png"
...
<List
  ...
  items={[
    {
      lead: "Step 1: Confirm it's actually flaky.",
...
<List
  ...
  items={[
    {
      text: "Use Docker with the same base image as your CI runners",
    },
    {
      text: 'Limit CPU and memory to match CI constraints: <span class="font-mono">docker run --cpus=2 --memory=4g</span>',
    },
    {
      text: "Run tests in parallel with the same worker count as CI",
    },
    {
      text: 'Add artificial load with <span class="font-mono">stress-ng</span> to simulate resource contention',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: "Categorize",
      text: "Is it a race condition, environment issue, or test design flaw? The symptoms tell you where to look.",
    },
    {
      lead: "Detect",
      text: "Track flake rates over time. A test that was stable and becomes flaky is different from a test that's always been flaky.",
    },
    {
      lead: "Quarantine",
      text: "Isolate flaky tests so they don't block CI, but hold them accountable with owners, tickets, and deadlines.",
    },
    {
      lead: "Diagnose",
      text: "Reproduce the flake, slow things down, add logging, identify what's racing.",
    },
    {
      lead: "Fix",
      text: "Wait for specific conditions instead of time, isolate test state, use resilient selectors.",
    },
  ]}
/>
