...
// ❌ FLAKY: Checking immediately after navigation
...
// ✅ STABLE: Account for timezone or force specific zone
...
// ❌ BRITTLE: Generated class names, structure-dependent
const badSelectors = {
...
// ✅ STABLE: Semantic selectors, test IDs
const goodSelectors = {
