...
<List
  ...
  items={[
    { text: "Lead time metrics: time to first deployment, service creation, and deployment lead time" },
    { text: "Friction metrics: ticket volume, self-service rate, and cognitive load" },
    { text: "Reliability indicators: failed deployments, rollback frequency, and mean time to recovery" },
    { text: "Developer satisfaction: NPS, CSAT, and qualitative feedback" },
    { text: "DORA framework: deployment frequency and industry benchmarks" },
    { text: "Observability for platform metrics: measuring from systems and surveys" },
    { text: "Comparative analysis: tracking improvement over time" },
    { text: "Communicating platform value to leadership and stakeholders" },
  ]}
/>
