            ...
            tr: [
                {
                    ...
                    td: ["Doesn't indicate if they're productive", 'Time to first deployment for new developers'],
                },
                {
                    th: '"10 million API calls/month"',
                    td: ['Could be inefficient polling or errors', 'Successful self-service completions'],
                },
                {
                    th: '"99.99% uptime"',
                    td: ['Available but unusable is still failure', 'Successful deployment rate, P99 latency'],
                },
                {
                    th: '"1000 deployments this month"',
                    td: ['Includes failures, rollbacks, test envs', 'Production deployment success rate'],
                },
                {
