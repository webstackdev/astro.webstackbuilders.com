...
import continuousImprovementDiagram from "./diagrams/continuous-improvement-cycle.png"
...
<List
  ...
  items={[
    {
      text: 'Borrow someone from an adjacent team',
    },
    {
      text: 'Hire a contractor for acknowledge-and-escalate coverage',
    },
    {
      text: 'Temporarily reduce alerting sensitivity and accept slower response times',
    },
  ]}
/>
...
<List
  ...
  items={[
    ...
    {
      lead: 'P2 (High)',
      text: 'is significant degradation but the service is still functional. Elevated error rates, one replica down out of three, performance degraded 2x from baseline. These page during business hours but only notify (no phone call) after hours. Target response is under an hour during business hours.',
    },
    {
      lead: 'P3 (Medium)',
    ...
    {
      lead: 'P4 (Low)',
      text: 'is informational. Traffic 20% above normal, new warning in logs, dependency updated. Log these for weekly review. No notification at all.',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      text: 'Did this require human action?',
    },
    {
      text: 'Could it have been prevented?',
    },
    {
      text: 'Could it have waited until morning?',
    },
    {
      text: 'Was the runbook sufficient?',
    },
    {
      text: 'Should this alert exist at all?',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: 'Tier 1',
      text: 'is the primary on-call. They get the initial page via push notification and phone call. The expectation is acknowledgment within 10-15 minutes and beginning investigation.',
    },
    {
      lead: 'Tier 2',
...
<List
  ...
  items={[
    {
      text: 'What this alert means in plain English',
    },
    {
      text: 'Why we alert on this (what\'s the user impact)',
    },
    {
      text: 'The first three things to check',
    },
    {
      text: 'How to mitigate if known',
    },
    {
      text: 'When to escalate',
    },
    {
      text: 'Who owns this system',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: 'Empty runbooks',
      text: 'where the alert exists but there\'s no documentation. Rule: no alert goes live without a runbook.',
    },
    {
...
<List
  ...
  items={[
    {
      text: 'Calculate your current signal-to-noise ratio. What percentage of pages required action?',
    },
    {
      text: 'Implement after-hours filtering: P1 pages anytime, P2 during business hours only',
    },
    {
    ...
    {
      text: 'Set up basic metrics: page volume per person per week, auto-resolve rate',
    },
  ]}
/>
