  ...
  content={{
    ...
    tbody: {
      tr: [
        {
          th: 'Primary',
          td: ['Handles all pages, first responder'],
        },
        {
          th: 'Secondary',
          td: ["Backup if primary doesn't acknowledge within 15 minutes"],
        },
        {
          th: 'Off',
    ...
    figure: 'Three-person rotation roles.',
  }}
/>
...
<List
  ...
  items={[
    {
      lead: 'Borrow someone from an adjacent team',
    },
    {
      lead: 'Hire a contractor for acknowledge-and-escalate coverage',
    },
    {
      lead: 'Temporarily reduce alerting sensitivity and accept slower response times',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: 'P1 (Critical)',
      text: 'Means the service is down or severely degraded for users. Homepage returning 500s, payment processing failing, database unreachable. These page immediately, any time of day. Target response is under 15 minutes. If you\'re getting more than one P1 per week on average, something is fundamentally broken.',
    },
    {
      lead: 'P2 (High)',
      text: 'Significant degradation but the service is still functional. Elevated error rates, one replica down out of three, performance degraded 2x from baseline. These page during business hours but only notify (no phone call) after hours. Target response is under an hour during business hours.',
    },
    {
      lead: 'P3 (Medium)',
      text: 'Needs attention but isn\'t urgent. Disk usage at 80%, certificate expiring in 14 days, elevated but stable error rate. These create tickets and get addressed the next business day. They never page.',
    },
    {
      lead: 'P4 (Low)',
      text: 'Informational. Traffic 20% above normal, new warning in logs, dependency updated. Log these for weekly review. No notification at all.',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: 'Did this require human action?',
    },
    {
      lead: 'Could it have been prevented?',
    },
    {
      lead: 'Could it have waited until morning?',
    },
    {
      lead: 'Was the runbook sufficient?',
    },
    {
      lead: 'Should this alert exist at all?',
    },
  ]}
/>
...
<Table
  ...
  content={{
    ...
    tbody: {
      tr: [
        {
          th: 'Required immediate action',
          td: ['> 70%', 'Good alert, keep it'],
        },
        {
          th: 'Auto-resolved before ack',
          td: ['< 15%', 'Add duration requirement'],
        },
        {
          th: 'False positive',
          td: ['< 5%', 'Fix detection logic'],
        },
        {
          th: 'Could have waited',
          td: ['< 10%', 'Demote severity'],
        },
      ],
    },
    figure: 'Alert quality targets.',
  }}
/>
...
<List
  ...
  items={[
    {
      lead: 'Tier 1:',
      text: 'The primary on-call. They get the initial page via push notification and phone call. The expectation is acknowledgment within 10-15 minutes and beginning investigation.',
    },
    {
      lead: 'Tier 2:',
      text: 'The secondary on-call. If the primary doesn\'t acknowledge within the timeout, the secondary gets paged. Same notification method — push plus phone call. Their job is to take over if the primary is unavailable.',
    },
    {
      lead: 'Tier 3:',
      text: 'The engineering manager or team lead. If neither primary nor secondary responds within 30 minutes total, escalate to management. At this point, the goal isn\'t necessarily for the manager to fix the problem — it\'s to coordinate a response and call in additional help if needed.',
    },
  ]}
/>
...
<Table
  ...
  content={{
    thead: {
      th: ['Severity', 'Business Hours', 'After Hours', 'Weekends'],
    },
    tbody: {
      tr: [
        {
          th: 'P1 Critical',
          td: ['Page immediately', 'Page immediately', 'Page immediately'],
        },
        {
          th: 'P2 High',
          td: ['Page immediately', 'Slack notification only', 'Slack notification only'],
        },
        {
          th: 'P3 Medium',
          td: ['Slack notification', 'Silent (ticket created)', 'Silent (ticket created)'],
        },
      ],
    },
    figure: 'Time-based alert routing rules.',
  }}
/>
...
<List
  ...
  items={[
    ...
    },
    {
      ...
      text: 'Three questions: What\'s the user impact? How many users are affected? Is it getting worse? Spend no more than 5 minutes on initial assessment.',
    },
    {
      lead: 'Step 3: Communicate for P1 and P2 incidents.',
      text: 'Post to your incident channel with the key details: what\'s happening, what\'s the impact, current status, who\'s handling it. This keeps stakeholders informed without requiring you to answer individual questions.',
    },
    {
    ...
    },
    {
      ...
      text: 'Check monitoring, spot-check user flows, verify no new error reports. Update the incident channel with resolution.',
    },
    {
      lead: 'Step 6: Follow up within 24 hours.',
      text: 'Create a post-incident ticket documenting the timeline, root cause if known, and action items. This doesn\'t need to be a formal postmortem for every incident, but there should be a record.',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: 'What this alert means in plain English',
    },
    {
      lead: 'Why we alert on this (what\'s the user impact)',
    },
    {
      lead: 'The first three things to check',
    },
    {
      lead: 'How to mitigate if known',
    },
    {
      lead: 'When to escalate',
    },
    {
      lead: 'Who owns this system',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      title: 'Empty runbooks:',
      lead: 'Alerts that exist but there\'s no documentation. Rule: no alert goes live without a runbook.',
    },
    {
      title: 'Outdated runbooks:',
      lead: 'Commands that reference old systems or defunct processes — review runbooks quarterly.',
    },
    {
      title: 'Novel-length runbooks:',
      lead: 'Too long to read at 3 AM — people skip them and make mistakes.',
    },
    {
      title: 'Expert-assumed runbooks:',
      lead: 'Only makes sense if you already know the system — write for someone who\'s never seen this before.',
    },
  ]}
/>
  ...
  content={{
    ...
    tbody: {
      tr: [
        ...
        {
          th: 'Night pages per week',
          td: ['< 1', '1-3', '> 3'],
        },
        {
          th: 'Auto-resolve rate',
          td: ['< 20%', '20-40%', '> 40%'],
        },
      ],
    },
    figure: 'On-call health thresholds.',
  }}
/>
...
<Table
  ...
  content={{
    thead: {
      th: ['Practice', 'Implementation', 'Impact'],
    },
    tbody: {
      tr: [
        {
          th: 'Late start after night page',
          td: ['Start at 11am instead of 9am', 'Recovery time'],
        },
        {
          th: 'Page budget',
          td: ['Stop features if > N pages/week', 'Forces alert quality'],
        },
        {
          th: 'Weekly review',
          td: ['30 min handoff meeting', 'Continuous improvement'],
        },
        {
          th: 'Off rotation person',
          td: ['Always 1 of 3 fully off', 'Sustainable coverage'],
        },
      ],
    },
    figure: 'Sustainability practices summary.',
  }}
/>
...
<List
  ...
  items={[
    {
      lead: 'Two schedules',
      text: 'Primary and secondary. The secondary schedule should be offset by one position — if Alice is primary this week, Bob is secondary. This ensures the secondary is always a different person than the primary.',
    },
    {
      lead: 'Support hours',
      text: 'On each service, defining when business hours are. This enables different urgency rules during and outside business hours.',
    },
    {
      lead: 'Event rules',
      text: 'To route alerts by severity. P1 (critical) alerts should always be high urgency regardless of time. P2 (warning) alerts should be high urgency during business hours, low urgency after hours. Low urgency means push notification only — no phone call.',
    },
    {
      lead: 'Suppression rules',
      text: 'For known noisy alerts. If you have an alert that\'s flaky and you haven\'t fixed it yet, suppress it rather than training your team to ignore pages. (Then actually fix it — see the Alert Hygiene section for how to systematically address noise sources.)',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: 'Disk space alerts',
      text: 'When disk usage exceeds 85%, automatically clear /tmp files older than 7 days, rotate logs, and clear package caches. Only escalate to a human if usage is still high after cleanup.',
    },
    {
      lead: 'Certificate expiration',
      text: 'When a certificate is within 14 days of expiry, trigger cert-manager to renew it. Only page if renewal fails.',
    },
    {
      lead: 'Unhealthy pods',
      text: 'When a Kubernetes pod is unhealthy for more than 5 minutes, delete it and let the scheduler create a replacement. Only page if the replacement is also unhealthy. Limit auto-restarts to 2 per hour to prevent infinite loops.',
    },
  ]}
/>
...
<Table
  ...
  fullWidth={false}
  content={{
    figure: 'Core metrics and thresholds for an on-call health dashboard.',
    thead: {
      th: ['Metric', 'Target', 'Alert threshold'],
    },
    tbody: {
      tr: [
        {
          th: 'Pages per week per person',
          td: ['< 5', '> 10 triggers review'],
        },
        {
          th: 'Time to acknowledge (P95)',
          td: ['< 15 min', '> 20 min'],
        },
        {
          th: 'Time to resolution (P50)',
          td: ['< 30 min', 'Varies by severity'],
        },
        {
          th: 'After-hours pages',
          td: ['< 1/week average', '> 3/week'],
        },
        {
          th: 'Auto-resolve rate',
          td: ['< 15%', '> 30% indicates noise'],
        },
        {
          th: 'Signal-to-noise ratio',
          td: ['> 80%', '< 60% indicates quality issues'],
        },
      ],
    },
  }}
...
<List
  ...
  items={[
    {
      lead: 'Page volume',
      text: 'Your primary health indicator. More than 10 pages per person per week is unsustainable — that\'s two pages per day, every day, on top of regular work.',
    },
    {
      lead: 'Response time',
      text: 'Measures team engagement. If P95 acknowledgment time is creeping up, people are either overwhelmed or checked out. Either way, it\'s a warning sign.',
    },
    {
      lead: 'After-hours pages',
      text: 'Deserve special tracking because they\'re disproportionately costly. One 3am page has more impact on a person than three 2pm pages.',
    },
    {
      lead: 'Auto-resolve rate',
      text: 'Counterintuitive — you want it low. If more than 30% of your alerts resolve before anyone acknowledges them, your thresholds are too sensitive. You\'re paging people for things that fix themselves.',
    },
  ]}
/>
...
<List
  ...
  items={[
    ...
    },
    {
      ...
      text: 'comes from your incident management platform\'s webhook events. When an incident resolves, check whether it was ever acknowledged. If it resolved before acknowledgment, increment a counter. Most platforms expose this via their API or webhook payloads.',
    },
  ]}
/>
...
<Diagram
  src={continuousImprovementDiagram}
  size="full"
  title="Continuous improvement cycle."
  description="Left-to-right flowchart showing a repeating on-call improvement loop. It starts with Alert Fires,
  then moves to Incident Handled, then Weekly Review. The review asks a decision question: Was alert good?
  If the answer is yes, the path goes to No change. If the answer is no, the path goes to Improvement Action.
  From Improvement Action, the flow branches into four possible changes: Tune threshold, Add automation,
  Delete alert, or Update runbook. All four branches lead to Implement, which then leads to Measure Impact,
  and then to Next Week's Review. The overall meaning is that each handled incident feeds a weekly review,
  poor alerts trigger concrete improvements, and those changes are measured and reviewed again in the next cycle."
/>
...
<List
  ...
  items={[
    {
      lead: 'Calculate your current signal-to-noise ratio. What percentage of pages required action?',
    },
    {
      lead: 'Implement after-hours filtering: P1 pages anytime, P2 during business hours only',
    },
    {
    ...
    {
      lead: 'Set up basic metrics: page volume per person per week, auto-resolve rate',
    },
  ]}
/>
