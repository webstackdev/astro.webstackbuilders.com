...
<Table
  ...
  content={{
    ...
    tbody: {
      tr: [
        {
          th: 'Did this require human action?',
          td: ['Alert is noise—delete or demote it'],
        },
        {
          th: 'Could it have been prevented?',
          td: ['Missing automation or monitoring gap'],
        },
        {
          th: 'Could it have waited until morning?',
          td: ['Severity is miscategorized'],
        },
        {
          th: 'Was the runbook sufficient?',
          td: ['Documentation debt'],
        },
        {
          th: 'Should this alert exist at all?',
          td: ['Legacy cruft—delete it'],
        },
      ],
    },
    figure: 'Weekly review questions and what they reveal.',
  }}
/>
