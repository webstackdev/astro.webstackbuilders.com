...
import contractTestingWorkflowDiagram from "./diagrams/contract-testing-workflow-showing-consumer-first-approach_article.png"
import contractViolationDiagram from "./diagrams/contract-violation-detected-at-PR-time-not-production.png"
