...
<List
  ...
  items={[
    {
      lead: "Usage score (35%)",
      text: "Based on views and unique viewers in the last 30 days. Zero views scores zero; 100+ views with 10+ unique viewers scores full marks.",
    },
    {
      lead: "Freshness score (25%)",
      text: "Based on time since last edit. Edited in the last 30 days scores 100; over a year without edits scores 0.",
    },
    {
      lead: "Ownership score (25%)",
      text: "Has an assigned owner? Has a team tag? Has any tags at all? Each adds points.",
    },
    {
      lead: "Quality score (15%)",
      text: "Penalize broken panels heavily (they actively mislead), excessive complexity (30+ panels), and suspiciously simple dashboards (fewer than 3 panels might be incomplete).",
    },
  ]}
/>
