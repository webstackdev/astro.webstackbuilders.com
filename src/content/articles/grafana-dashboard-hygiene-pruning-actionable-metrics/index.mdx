...
<List
  ...
  items={[
    {
      lead: "New services get dashboards",
      text: "When a team launches a service, they create a dashboard for it. This is correct behavior. But when the service is deprecated or merged into another, the dashboard stays. Nobody thinks to delete it because nobody's tracking which dashboards map to which services.",
    },
    {
      lead: "Incidents spawn debug dashboards",
      text: "During an outage, someone creates \"DEBUG - payment latency investigation\" to correlate metrics. The incident gets resolved. The dashboard sits there forever because deleting it feels like destroying evidence. Six months later, there are forty \"DEBUG-\" dashboards, and nobody remembers what any of them were investigating.",
    },
    {
      lead: "Cloning is easier than customizing",
      text: "An engineer wants the payments dashboard but with their team's specific filters. They clone it. Now there are two dashboards. The original gets updated; the clone diverges. Next quarter, there are seven variants, all slightly different, none clearly authoritative.",
    },
    {
      lead: "Teams reorganize but dashboards don't",
      text: "When Platform Team A splits into Platform Infra and Platform Services, nobody updates dashboard ownership. The dashboards from the old team become orphans. People are reluctant to touch them because \"Platform Team A\" might still need them — even though that team no longer exists.",
    },
    {
      lead: "Nobody deletes anything",
      text: "Deletion feels risky. What if someone needs it? What if there's data we can't recreate? The safe choice is always to keep it. Multiply this instinct across an organization and you guarantee accumulation.",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: "View metrics",
      text: "Tell you whether anyone actually looks at this dashboard. Track views in the last 30 days, unique viewers (one person looking 50 times is different from 50 people looking once), and the last viewed date. A dashboard that hasn't been viewed in 90 days is a strong deletion candidate.",
    },
    {
      lead: "Edit metrics",
      text: "Indicate maintenance activity. Track the last edit date, total edit count (the version number), and who made the last edit. A dashboard that was created two years ago and never edited is likely stale — either it's perfect (unlikely) or it's been abandoned.",
    },
    {
      lead: "Ownership metadata",
      text: "Identifies who's responsible. Look for owner tags, team assignments, and the original creator. Dashboards without clear ownership are the hardest to make decisions about because nobody feels empowered to delete them.",
    },
    {
      lead: "Quality indicators",
      text: "Flag technical problems. Count broken panels (those referencing deleted datasources), total panel count (excessive complexity suggests the dashboard should be split), and check for common naming anti-patterns like \"Copy of\" or \"test\" in the title.",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      title: "Usage score (35%)",
      lead: "Based on views and unique viewers in the last 30 days.",
      text: "Zero views scores zero; 100+ views with 10+ unique viewers scores full marks.",
    },
    {
      title: "Freshness score (25%)",
      lead: "Based on time since last edit.",
      text: "Edited in the last 30 days scores 100; over a year without edits scores 0.",
    },
    {
      title: "Ownership score (25%)",
      lead: "Has an assigned owner?",
      text: "Has a team tag? Has any tags at all? Each adds points.",
    },
    {
      title: "Quality score (15%)",
      lead: "Penalize broken panels heavily (they actively mislead),",
      text: "excessive complexity (30+ panels), and suspiciously simple dashboards (fewer than 3 panels might be incomplete).",
    },
  ]}
/>
  ...
  items={[
    {
      ...
      text: "Writing raw JSON is tedious and error-prone. Tools like Jsonnet (with the Grafonnet library), Python (with grafanalib), or Terraform's Grafana provider let you define dashboards programmatically. You get variables, loops, and functions — create a template once, generate dashboards for all your services.",
    },
    {
      lead: "Version control workflow",
      text: "Dashboard changes go through pull requests. Someone reviews the diff. Changes deploy automatically through provisioning or the Grafana API. You get audit history, easy rollback, and the ability to see exactly what changed when a dashboard stopped working.",
    },
    {
      lead: "When to use which approach",
      text: "Browser editing is fine for personal exploration dashboards and one-off debugging. Code-managed dashboards are better for anything canonical — service health dashboards, SLO dashboards, team operational views. The rule of thumb: if multiple people rely on it, it should be in version control.",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: "Ownership requirements",
      text: "Every dashboard must have an owner. Owners keep dashboards accurate, respond to questions, update or delete when services change, and hand off ownership when leaving a team. Ownership isn't optional — it's the foundation of accountability.",
    },
    {
      lead: "Folder structure",
      text: "Organize folders by domain. Team dashboards go under team names. Service dashboards go under service names. SLO dashboards get their own area. Incident investigation dashboards live in a flat \"Incidents\" folder with auto-expiration. Personal exploration dashboards live in personal folders and are exempt from most governance (but not from usage tracking).",
    },
    {
      lead: "Naming conventions",
      text: "Use a consistent pattern like \"[Service/Team] - [Purpose] - [Scope].\" Good examples: \"Payments - API Performance - Production\" or \"SLO - Checkout Success Rate - P99.\" Bad examples: \"New Dashboard,\" \"Copy of Copy of...,\" \"Test123,\" or \"DEBUG - delete me.\" Names that violate the pattern are automatic review candidates.",
    },
    {
      lead: "Tagging requirements",
      text: "Require `owner:{username}` and `team:{team-name}` tags on every dashboard. Recommend additional tags for service, environment, and purpose. Tags make bulk operations possible — you can't email all owners of payment-related dashboards if there's no consistent way to identify them.",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: "Daily",
      text: "Collect usage metrics. Store them for historical analysis.",
    },
    {
      lead: "Weekly",
      text: "Calculate health scores. Generate reports. Take automated actions based on score thresholds.",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: "Vanity dashboards",
      text: "Show metrics that look impressive but drive no action. The classic example is \"Total requests served\"—an ever-increasing counter that tells you nothing useful. Replace with rate of change or comparison to baseline.",
    },
    {
      lead: "Kitchen sink dashboards",
      text: "Have too many panels with no clear narrative. Fifty panels showing every available metric helps no one. Split into an overview dashboard plus detail dashboards for specific investigations.",
    },
    {
      lead: "Wall of green dashboards",
      text: "Have thresholds set so permissively that nothing ever triggers. If everything always looks fine, the dashboard provides no signal. Calibrate thresholds to actual SLOs and historical variance.",
    },
    {
      lead: "Mystery meat dashboards",
      text: "Have panels with no titles, unlabeled axes, or missing legends. A graph with y-axis labeled \"value\" is useless without context. Every panel needs a title, description, and unit labels.",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: "SLO Status row",
      text: "Error budget remaining (gauge with percentage thresholds), 30-day rolling availability (stat with SLO target threshold)",
    },
    {
      lead: "Traffic & Latency row",
      text: "Request rate with anomaly alerting, latency distribution showing p50/p95/p99 with threshold lines",
    },
    {
      lead: "Errors row",
      text: "Error rate as percentage with target threshold, error breakdown by type (pie chart for quick triage)",
    },
    {
      lead: "Resources row",
      text: "CPU and memory utilization (watch for gradual increases), instance count compared to expected baseline",
    },
    {
      lead: "Links section",
      text: "Deep-dive dashboard, runbook URL, log explorer query",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: "If no",
      text: "Check for an assigned owner. No owner and no views? Delete it — this is an orphaned, unused dashboard. If there is an owner, contact them. If they confirm they need it despite no views (perhaps it's quarterly reporting), document the justification and keep it. If they don't need it, delete it.",
    },
    {
      lead: "If yes, but barely (fewer than 5 views per month)",
      text: "Check if it's a single viewer. If one person created it and they're the only one viewing it, it's a personal dashboard — move it to their Personal folder where it won't clutter team searches. If a single viewer is using someone else's dashboard, investigate why only one person finds it useful. If multiple people view it even occasionally, keep it — there's value there.",
    },
    {
      lead: "If it's actively viewed",
      text: "Check for broken panels (panels referencing deleted datasources). Fix or remove them — broken panels actively mislead anyone looking at the dashboard. Then check for duplicates. If this dashboard is substantially similar to another with more usage, consolidate them: keep the more-used one, redirect users of the other, then delete it. If it's healthy and not a duplicate, keep it.",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: "Four weeks before",
      text: "Run the usage analysis and generate health scores. Identify all dashboards below threshold. Generate reports by team so leads know what's coming. Draft the campaign communication.",
    },
    {
      lead: "Two weeks before",
      text: "Send preview reports to team leads. Announce the campaign dates, process, and deadlines. Open a window for exception requests — if someone needs to keep a low-scoring dashboard, they need to explain why now, not during the campaign.",
    },
    {
      lead: "Campaign week one",
      text: "Send individual notifications to every dashboard owner with flagged dashboards. Open a self-service portal where owners can mark dashboards as \"keep,\" \"delete,\" or \"archive.\" Send daily reminders to non-responders. Hold office hours for questions.",
    },
    {
      lead: "Campaign week two",
      text: "Final warnings. Escalate to team leads for stragglers. Most owners respond in week one once they realize the deadline is real.",
    },
    {
      lead: "Week three",
      text: "Auto-archive everything unclaimed. Send notifications with restore instructions.",
    },
    {
      lead: "Week seven",
      text: "Delete archived dashboards with no restore requests. Publish results.",
    },
  ]}
/>
  ...
  items={[
    {
      ...
      text: "Dashboards viewed per week divided by total dashboards. Higher is better — it means your dashboards are actually useful.",
    },
    {
      lead: "Average health score",
      text: "Tracks portfolio quality over time. Should trend upward as you clean up and maintain.",
    },
    {
      lead: "Time to find the right dashboard during an incident",
      text: "The metric that actually matters. If engineers can't find the right dashboard quickly, your observability isn't helping when it counts.",
    },
    {
      lead: "Dashboard load time p95",
      text: "Slow dashboards get abandoned. Track this to catch complexity creep.",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: "\"I might need it someday.\"",
      text: "Archive, don't delete. We'll keep the JSON for 90 days. If you need it, you can restore it. In three years of cleanups, we've had two restore requests.",
    },
    {
      lead: "\"It's not hurting anyone.\"",
      text: "It is. During the last incident, engineers wasted 8 minutes finding the right dashboard among 47 search results. That's 8 minutes of extended outage. Document your own incident data to make this argument concrete.",
    },
    {
      lead: "\"I don't have time.\"",
      text: "The hygiene automation handles 80% of cases. You only need to review dashboards flagged for your attention — usually 5-10 per quarter. Most reviews take under a minute each.",
    },
    {
      lead: "\"Someone else might use it.\"",
      text: "Usage data shows nobody has viewed this in 6 months. If someone needs it, they'll create their own — which they'd do anyway since this one is outdated.",
    },
    {
      lead: "\"It's my personal dashboard.\"",
      text: "Great! Move it to your Personal folder. Personal dashboards are exempt from cleanup but won't clutter team search results.",
    },
    {
      lead: "\"The process is too bureaucratic.\"",
      text: "For most dashboards, it's one click: keep, archive, or delete. The detailed process is only for disputed cases. 90% of owners complete review in under 5 minutes.",
    },
  ]}
/>
...
<Download
  resource="grafana-dashboard-hygiene-pruning-actionable-metrics"
  title="Download the Dashboard Hygiene Guide"
  description="Get the complete observability cleanup playbook for dashboard scoring, pruning decisions, and sustainable ownership workflows."
  listItems={[
    {
      text: "Dashboard health scoring framework",
    },
    {
      text: "Pruning decision tree guide",
    },
    {
      text: "Ownership governance policy templates",
    },
    {
      text: "Cleanup campaign execution plan",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: "Track usage from day one",
      text: "You can't make evidence-based decisions without data.",
    },
    {
      lead: "Calculate health scores objectively",
      text: "Removes politics from cleanup decisions.",
    },
    {
      lead: "Automate the warning-archive-delete pipeline",
      text: "Manual processes don't scale.",
    },
    {
      lead: "Design actionable dashboards that answer specific questions",
      text: "Prevention is cheaper than cleanup.",
    },
    {
      lead: "Run regular cleanup campaigns",
      text: "Creates urgency and clears backlogs.",
    },
    {
      lead: "Build a culture where deletion is celebrated",
      text: "Process without culture change fails.",
    },
  ]}
/>
