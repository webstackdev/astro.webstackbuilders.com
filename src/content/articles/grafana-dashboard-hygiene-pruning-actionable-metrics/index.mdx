  ...
  items={[
    {
      ...
      text: "When a team launches a service, they create a dashboard for it. But when the service is deprecated or merged into another, the dashboard stays. Nobody thinks to delete it because nobody's tracking which dashboards map to which services.",
    },
    {
    ...
    },
    {
      ...
      text: "Deletion feels risky. What if someone needs it? The safe choice is always to keep it. Multiply this instinct across an organization and you guarantee accumulation.",
    },
  ]}
/>
  ...
  items={[
    {
      ...
      text: "Archive, don't delete. Keep the JSON export for 90 days. If you need it, you can restore it. In three years of cleanups, most organizations see fewer than 1% of archived dashboards ever requested back.",
    },
    {
      lead: "\"It's not hurting anyone.\"",
      text: "It is. During incidents, engineers waste time finding the right dashboard among dozens of stale results. Document your own incident data to make this argument concrete — if your last outage included 8 minutes searching for the right dashboard, that's 8 minutes of extended downtime.",
    },
    {
      lead: "\"I don't have time.\"",
      text: "The hygiene automation handles 80% of cases. Dashboard owners only need to review dashboards flagged for their attention — usually 5-10 per quarter. Most reviews take under a minute each.",
    },
    {
