...
This scenario plays out constantly. <Highlighter>Service account keys are the most common entry point for cloud breaches, and the attack vector is almost always the same: a static credential that was created, copied somewhere, and forgotten.</Highlighter>
  ...
  items={[
    {
      ...
      text: 'Where the token came from — <span class="font-mono">https://token.actions.githubusercontent.com</span>',
    },
    {
      lead: '<span class="font-mono">sub</span> (subject)',
      text: 'The specific workload identity — <span class="font-mono">repo:myorg/myrepo:ref:refs/heads/main</span>',
    },
    {
