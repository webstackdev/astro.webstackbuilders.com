...
import shadowTrafficDiagram from "./diagrams/shadow-traffic-architecture-with-async-mirroring.png"
...
<List
  ...
  items={[
    {
      text: "Mismatch rate below 0.1% (or whatever threshold you've defined as acceptable)",
    },
    {
      text: 'No systematic errors-random noise is fine, but patterns indicate bugs',
    },
    {
      text: 'Latency within 20% of legacy system (the new system being faster is fine; much slower is a problem)',
    },
    {
      text: 'No memory leaks or connection pool exhaustion under sustained load',
    },
  ]}
/>
