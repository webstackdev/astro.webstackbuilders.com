  ...
  items={[
    {
      ...
      text: 'Setting <span class="text-mono">pool_size = 100</span> "just in case" means 10 instances create 1000 connections. Size based on actual need, not fear.',
    },
    {
