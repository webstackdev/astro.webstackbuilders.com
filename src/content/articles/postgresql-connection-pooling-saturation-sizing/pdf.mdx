    ...
    items: [
      {
        ...
        text: 'is the primary signal. Query `pg_stat_activity` to compare current connections against `max_connections`. Alert at 70% utilization, investigate at 85%. By 95%, you\'re one slow query away from exhaustion.',
      },
    ],
  }}
/>
