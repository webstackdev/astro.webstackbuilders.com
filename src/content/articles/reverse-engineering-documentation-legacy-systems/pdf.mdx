...
import eventFlowDiagram from "./diagrams/event-flow-topology-discovered-through-runtime-observation.png"
import serviceTopologyDiagram from "./diagrams/service-topology-diagram-generated-from-tracing-data.png"
...
<List
  ...
  items={[
    {
      text: '"Walk me through what happens when a user places an order."',
    },
    {
      text: '"What would break if the payment service went down?"',
    },
    {
      text: '"What\'s the scariest part of this codebase to change?"',
    },
    {
      text: '"Why did we choose Kafka instead of SQS?"',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      text: '"What\'s the most common thing that pages you at night?"',
    },
    {
      text: '"What manual steps are required for deployments?"',
    },
    {
      text: '"What\'s the recovery procedure when the database fills up?"',
    },
    {
      text: '"Where do you look first when debugging slow API responses?"',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      text: '"What major changes happened in the last two years?"',
    },
    {
      text: '"Why does that weird retry loop exist in the payment handler?"',
    },
    {
      text: '"What features were removed, and why?"',
    },
    {
      text: '"What\'s the oldest code that\'s still running in production?"',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      text: '"What business rules are in the code that aren\'t written anywhere?"',
    },
    {
      text: '"What edge cases have special handling?"',
    },
    {
      text: '"What compliance requirements affect this code?"',
    },
  ]}
/>
