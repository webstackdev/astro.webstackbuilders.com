...
<List
  ...
  size={7}
  classes={{
    text: "italic font-semibold",
  }}
  items={[
    {
      text: '"What happens when a user places an order?"',
      icon: "paper-and-pen",
      color: "info",
      bgColor: "info-inverse",
    },
    {
      text: '"What breaks if the payment service goes down?"',
      icon: "dollar",
      color: "warning",
...
<List
  ...
  items={[
    {
      text: '"What pages you most often at night?"',
      icon: "on-call",
      color: "secondary",
      bgColor: "blue-100",
    },
    {
      text: '"What manual steps do deployments require?"',
      icon: "wrench",
      color: "success",
      bgColor: "success-inverse",
    },
    {
      text: '"Where do you look first when API responses slow down?"',
      icon: "api",
...
<List
  ...
  items={[
    {
      text: '"What business rules live in code but not in any document?"',
      icon: "gear",
      color: "accent",
      bgColor: "purple-100",
    },
    ...
    {
      text: '"What compliance requirements shaped this code?"',
      icon: "shield",
      color: "success",
      bgColor: "green-100",
    },
...
<Table
  ...
  content={{
    thead: {
      th: ['Interview Focus', 'Best Participants', 'Knowledge Domain'],
    },
    tbody: {
      tr: [
        {
          th: 'Architecture',
          td: ['Original architects, senior engineers', 'How components connect and why'],
        },
        {
          th: 'Operations',
          td: ['SREs, on-call engineers', 'Failure modes and recovery procedures'],
        },
        {
          th: 'Business Logic',
          td: ['Product managers, business analysts', 'Rules encoded in code but not in docs'],
        },
        {
          th: 'History',
          td: ['Long-tenured engineers', 'Why weird things exist'],
        },
      ],
    },
    figure: 'Interview types matched to knowledge domains.',
  }}
/>
  ...
  items={[
    {
      ...
      text: 'Code that everyone\'s afraid to change. Mistakes here have outsized consequences, so documentation provides essential guardrails.',
    },
    {
      lead: 'The confusing parts',
      text: 'Code that requires explanation to understand. If every new team member asks the same questions, write down the answers once.',
    },
    {
      lead: 'The business-critical parts',
      text: 'Code where mistakes cost money or trigger compliance violations. The stakes justify the documentation investment.',
    },
  ]}
/>
