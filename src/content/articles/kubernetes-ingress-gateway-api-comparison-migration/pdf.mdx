...
flowchart TD
  ...
  subgraph gatewayApiModel[Gateway API: Layered Resources]
  ...
  content={{
    ...
    tbody: {
      tr: [
        {
          th: 'HTTP',
          td: ['✓ Native', '✓ HTTPRoute', 'GA'],
        },
        {
          th: 'HTTPS (terminate)',
          td: ['✓ Native', '✓ HTTPRoute + TLS', 'GA'],
        },
        {
          th: 'HTTPS (passthrough)',
          td: ['Annotation-dependent', '✓ TLSRoute', 'GA'],
        },
        {
          th: 'TCP',
          td: ['Not supported', '✓ TCPRoute', 'Beta'],
        },
        {
          th: 'UDP',
          td: ['Not supported', '✓ UDPRoute', 'Alpha'],
        },
        {
          th: 'gRPC',
          td: ['Annotation-dependent', '✓ GRPCRoute', 'GA'],
        },
      ],
    },
    figure:
...
In organizations with multiple teams, the question of __who manages what__ becomes critical. With Ingress, there's no natural separation — anyone with permission to create Ingress resources in a namespace can affect cluster-wide routing behavior. This leads to either overly permissive access (risky) or centralized bottlenecks where a platform team manages all routing (slow).
...
flowchart TD
  ...
  subgraph appTeamA[App Team A]
    E[HTTPRoute A] -->|parentRef| C
    E --> F[Service A]
  end

  subgraph appTeamB[App Team B]
...
<List
  ...
  items={[
    {
      text: 'You\'re in the middle of a major release or incident stabilization period',
    },
    {
      text: 'The team responsible for routing config doesn\'t have capacity for learning and testing',
    },
    {
      text: 'Your controller\'s Gateway API support is still in beta or missing route types you need',
    },
    {
      text: 'You have a complex `configuration-snippet` annotation that doesn\'t have a clear Gateway API equivalent',
    },
    {
      text: 'Your CI/CD pipeline doesn\'t have good staging coverage for routing changes',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      text: 'Controller supports Gateway API at GA level for the route types you need — most major controllers (NGINX Gateway Fabric, Envoy Gateway, Istio, Contour, Kong, Traefik) have GA support',
    },
    {
      text: 'Team has read the official Gateway API getting started guide',
    },
    {
      text: 'Staging environment can run parallel Ingress and Gateway API resources',
    },
    {
      text: 'Rollback plan documented (typically: delete HTTPRoute, traffic returns to Ingress)',
    },
    {
      text: 'Monitoring covers both Ingress and Gateway API traffic paths',
    },
    {
      text: 'At least one low-risk service identified for initial migration',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      text: 'Your routing needs are simple: host-based routing, path prefixes, TLS termination',
    },
    {
      text: 'Everything lives in one namespace (or a small number of namespaces managed by one team)',
    },
    {
      text: 'Your current setup works and you don\'t have concrete problems to solve',
    },
    {
      text: 'Your team doesn\'t have capacity to learn a new API right now',
    },
    {
      text: 'Your controller doesn\'t support Gateway API yet',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      text: 'You need cross-namespace routing (app teams routing to a shared Gateway)',
    },
    {
      text: 'You need native traffic splitting for canary or blue-green deployments',
    },
    {
      text: 'You need TCP, UDP, or gRPC routing',
    },
    {
      text: 'You\'re building a multi-team platform with self-service routing',
    },
    {
      text: 'You\'re planning a controller migration anyway',
    },
    {
      text: 'It\'s a greenfield project and you want to start with the more portable option',
    },
  ]}
/>
