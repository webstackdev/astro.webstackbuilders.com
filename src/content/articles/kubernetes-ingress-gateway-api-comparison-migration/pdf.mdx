...
import ingressDiagram from "./diagrams/ingress-uses-flat-resources-gateway-api-uses-shared-gateway.png"
import roleBasedDiagram from "./diagrams/role-based-ownership-with-gateway-api.png"
