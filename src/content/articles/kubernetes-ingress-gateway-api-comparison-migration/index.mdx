---
title: "Should You Migrate From Ingress to Gateway API?"
...
The answer: <Highlighter>Ingress was designed in 2015 as a minimal abstraction. It defines _what_ you want (route traffic to services) but leaves _how_ entirely to the controller.</Highlighter> Every controller filled that gap differently, creating the annotation mess you're now untangling.
  ...
  content={{
    ...
    tbody: {
      tr: [
        {
          th: 'Resource types',
          td: ['1', '3+ (GatewayClass, Gateway, *Route)'],
        },
        {
          th: 'Configuration',
