...
Error budgets change the game. <Highlighter>Instead of "should we ship this risky change?" the question becomes "do we have budget to spend on this risk?" The answer is a number, not an opinion.</Highlighter> And that number creates alignment where politics used to create friction.
...
<Diagram
  ...
  description="A left-to-right flowchart showing how teams turn service measurements into a delivery decision. SLI: Actual Measurements feed into SLO: Target Level. That target defines the Error Budget as 100 percent minus the SLO. Actual errors consume that budget, leading to a decision point labeled Budget Remaining? If budget remains, the flow continues to Ship Features. If no budget remains, the flow moves to Focus on Reliability. The diagram shows how remaining budget determines whether teams prioritize delivery or reliability work."
/>
...
<Table
  ...
  fullWidth={false}
  content={{
    figure: 'Error budget deployment decisions.',
    thead: {
      th: ['Without Error Budgets', 'With Error Budgets'],
    },
    tbody: {
      tr: [
        {
          th: '"Is this safe?"',
          td: ['"We have 25 minutes of budget remaining."'],
        },
        {
          th: 'Opinion-based arguments about risk tolerance',
          td: ['"This change historically costs 5-10 minutes."'],
        },
        {
          th: 'Whoever argues loudest wins',
          td: ['"If we hit the high end, we\'ll have 15 minutes left."'],
        },
        {
          th: 'Lingering resentment from overruled parties',
          td: ['"Are we comfortable with that margin?"'],
        },
      ],
    },
  }}
...
<Table
  ...
  fullWidth={false}
  content={{
    figure: 'Error budget policy thresholds.',
    thead: {
    ...
    tbody: {
      tr: [
        ...
        {
          th: '25% - 50%',
          td: ['Yellow', 'Increased scrutiny. Reliability work gets equal priority.'],
        },
        {
          th: '10% - 25%',
          td: ['Orange', 'Feature freeze for high-risk changes. SRE approval required.'],
        },
        {
          th: '< 10%',
          td: ['Red', 'Complete feature freeze. Only reliability improvements deployed.'],
        },
      ],
    },
  }}
