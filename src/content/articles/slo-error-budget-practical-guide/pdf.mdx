...
import fromSliDiagram from "./diagrams/from-SLI-measurement-to-error-budget-decision-flow.png"
...
<List
  ...
  items={[
    {
      text: 'Error budget = 100% - 99.9% = 0.1%',
    },
    {
      text: 'Minutes in month = 30 days × 24 hours × 60 minutes = 43,200',
    },
    {
      text: 'Allowed downtime = 43,200 × 0.001 = 43.2 minutes',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      text: 'SLIs must reflect user experience, not internal metrics',
    },
    {
      text: 'SLOs should be achievable with current architecture (start with reality, improve over time)',
    },
    {
      text: 'Error budgets convert reliability into a spendable resource',
    },
    {
      text: 'Budget policies remove politics from reliability decisions',
    },
    {
      text: 'When budget is healthy, spend it on velocity; when depleted, invest in reliability',
    },
  ]}
/>
