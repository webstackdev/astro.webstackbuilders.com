...
<List
  ...
  items={[
    { text: "OPA architecture: library mode, daemon mode, and CLI mode deployment" },
    { text: "Rego fundamentals: rules, conditions, iteration, and data querying" },
    { text: "Conftest integration: parsing Terraform, Kubernetes YAML, and Dockerfiles" },
    { text: "Pre-commit hooks: fast feedback in seconds, before commits" },
    { text: "CI enforcement: parallelized policy evaluation across infrastructure files" },
    { text: "Policy writing: building practical rules for cloud compliance" },
    { text: "Common guardrails: encryption, public access, resource limits, privileged containers" },
    { text: "Debugging violations: understanding why policies fail and fixing them" },
    { text: "Multi-environment policies: development, staging, and production rules" },
  ]}
/>
