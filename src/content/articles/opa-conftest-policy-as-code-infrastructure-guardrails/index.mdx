---
title: "Catch Infrastructure Violations Before They Reach Production"
  ...
  content={{
    ...
    tbody: {
      tr: [
        ...
        {
          th: 'Go',
          td: ['Lefthook', '<span class="font-mono">go install github.com/evilmartians/lefthook</span>'],
        },
      ],
    },
  }}
          ...
          children: [
            {
              ...
              name: 'pods',
              children: [
                { type: 'file', name: 'privileged.rego', comment: 'Blocks privileged pod configurations' },
                { type: 'file', name: 'resources.rego', comment: 'Requires pod resource settings' },
                { type: 'file', name: 'images.rego', comment: 'Restricts approved container registries' },
              ],
            },
            {
              type: 'folder',
