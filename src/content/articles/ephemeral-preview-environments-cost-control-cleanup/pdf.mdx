...
import costMonitoringDiagram from "./diagrams/cost-monitoring-and-escalation-flow.png"
import ephemeralEnvironmentDiagram from "./diagrams/ephemeral-environment-lifecycle-states.png"
import sharedVsDedicatedDiagram from "./diagrams/shared-vs-dedicated-resource-cost-comparison.png"
  ...
  content={{
    ...
    tbody: {
      tr: [
        ...
        {
          th: "`preview/managed-by`",
          td: ["Identifies automation-created resources", "`preview-controller`"],
        },
      ],
    },
  }}
...
<List
  ...
  items={[
    {
      lead: "Minimal",
      text: "Changes only in `docs/`, `README.md`, or `.md` files",
    },
    {
    ...
    {
      lead: "Enhanced",
      text: "PR labeled `performance-test` or `load-test`",
    },
    {
      lead: "Production-like (with approval)",
      text: "PR labeled `release-candidate`",
    },
  ]}
/>
