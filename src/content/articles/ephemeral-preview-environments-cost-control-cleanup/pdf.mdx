...
<Table
  ...
  content={{
    ...
    tbody: {
      tr: [
        { th: "Default", td: ["72 hours", "8 hours", "Standard PR development"] },
        { th: "Extended", td: ["1 week", "24 hours", "Long feature branches"] },
        {
          th: "Critical",
...
<List
  ...
  items={[
    { text: "**CI/CD pipeline**", lead: "Cleanup job triggered by PR close event" },
    { text: "**Webhooks**", lead: "Direct GitHub webhook to your cleanup service" },
    { text: "**TTL enforcement**", lead: "CronJob that deletes expired resources" },
    { text: "**Orphan detection**", lead: "Weekly scan for resources whose PRs no longer exist" },
  ]}
/>
...
<Table
  ...
  content={{
    ...
    tbody: {
      tr: [
        { th: "Idle timeout (4h)", td: ["Pause inactive environments", "40-60%"] },
        { th: "Schedule (nights/weekends)", td: ["Known non-working hours", "50-70%"] },
        { th: "Budget pressure", td: ["Team approaching limit", "Variable"] },
      ],
    },
  }}
/>
...
<List
  variant="check-icons-list"
  items={[
    { text: "Changes only in `docs/`, `README.md`, or `.md` files", lead: "_minimal_" },
    { text: "Changes in frontend code with no backend changes", lead: "_minimal_ or _standard_" },
    { text: "Standard backend changes", lead: "_standard_" },
    { text: "PR labeled `performance-test` or `load-test`", lead: "_enhanced_" },
    { text: "PR labeled `release-candidate`", lead: "_production-like_ (with approval)" },
  ]}
/>
...
<List
  variant="check-icons-list"
  items={[
    { text: "**Summary metrics**", lead: "Active environments, weekly cost, projected monthly cost, budget utilization" },
    { text: "**Team breakdown**", lead: "Table showing each team's environments, cost, and budget status" },
    { text: "**Longest running**", lead: "Environments over 7 days old, prompting review" },
    { text: "**Savings achieved**", lead: "How much was saved through hibernation, TTL cleanup, and orphan detection" },
    { text: "**Recommendations**", lead: "Auto-generated suggestions like \"Consider closing PR #456, running for 12 days with no activity\"" },
  ]}
/>
...
<List
  variant="check-icons-list"
  items={[
    { text: "**Treat environments as ephemeral**", lead: "Aggressive TTLs with automatic cleanup. If it hasn't been used in 72 hours, it probably won't be." },
    { text: "**Share infrastructure where possible**", lead: "Shared databases with schema isolation, shared caches with namespace prefixes. Dedicated resources only when testing actually requires them." },
    { text: "**Hibernate instead of delete**", lead: "Wake-on-access preserves the illusion of always-available environments while eliminating idle compute costs." },
    { text: "**Tag everything**", lead: "Consistent tagging enables orphan detection, cost attribution, and automated cleanup." },
    { text: "**Make costs visible**", lead: "PR comments, dashboards, and weekly reports create accountability without bureaucracy." },
  ]}
/>
