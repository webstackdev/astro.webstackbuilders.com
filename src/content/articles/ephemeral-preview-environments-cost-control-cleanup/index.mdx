---
title: "How We Cut Preview Environment Costs by 60 Percent"
...
<Highlighter>Preview environments for every PR sound like a developer experience win until someone notices the cloud bill.</Highlighter> I've seen this pattern play out multiple times: a team enables preview deployments, developers love the fast feedback loops, and six weeks later finance is asking why infrastructure costs tripled.
...
<Table
  ...
  content={{
    figure: "TTL policy tiers for different use cases.",
...
<Table
  ...
  content={{
    ...
    thead: { th: ["Trigger", "Typical Savings", "Use Case"] },
    tbody: {
      tr: [
        {
          th: "Hibernation timeout (4h idle)",
          td: ["40-60%", "Pause before TTL deletion"],
        },
        {
          th: "Schedule (nights/weekends)",
          td: ["50-70%", "Known non-working hours"],
        },
        {
          th: "Budget pressure",
          td: ["Variable", "Team approaching limit"],
        },
      ],
    },
  }}
...
<List
  ...
  items={[
    {
      lead: "TTL enforcement catches abandoned environments automatically",
      text: "Start here — it's the highest-impact change with the lowest implementation effort.",
    },
    {
      lead: "Shared infrastructure turns per-environment database costs into marginal schema costs",
      text: "The savings compound as your PR volume grows.",
    },
    {
      lead: "Hibernation eliminates idle compute costs while preserving developer experience",
      text: "Wake-on-access makes the cost savings invisible to users.",
    },
  ]}
/>
