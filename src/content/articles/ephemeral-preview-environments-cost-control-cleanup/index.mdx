      ...
      tr: [
        {
          ...
          td: ["Pause before TTL deletion", "40-60%"],
        },
        {
...
<List
  ...
  items={[
    {
      text: "**TTL enforcement** catches abandoned environments automatically.",
      lead: "Start here — it's the highest-impact change with the lowest implementation effort.",
    },
    {
      text: "**Shared infrastructure** turns per-environment database costs into marginal schema costs.",
      lead: "The savings compound as your PR volume grows.",
    },
    {
      text: "**Hibernation** eliminates idle compute costs while preserving developer experience.",
      lead: "Wake-on-access makes the cost savings invisible to users.",
    },
  ]}
/>
