---
title: "Why Your Kubernetes Bill Is Higher Than It Should Be"
...
The good news: <Highlighter>Kubernetes cost optimization has three levers, and two of them deliver 80% of the savings.</Highlighter> Use cheaper compute (spot instances), use less compute (right-sizing), and use compute more efficiently (bin packing). This article focuses on right-sizing and spot - the changes you can make this week that will actually move your bill.
  ...
  content={{
    ...
    tbody: {
      tr: [
        ...
        {
          th: "Cluster capacity",
          td: ["Sum of requests = scheduleable capacity", "Sum of limits can exceed node capacity"],
        },
        {
          th: "Cost impact",
...
<List
  ...
  items={[
    {
      lead: "Deploy VPAs in recommendation mode for all deployments",
    },
    {
      lead: "Review recommendations weekly",
    },
    {
      lead: "Apply changes through the normal deployment process (not via VPA auto-apply)",
    },
    {
      lead: "Validate that workloads remain healthy after the change",
    },
  ]}
/>
