  ...
  content={{
    ...
    tbody: {
      tr: [
        {
          th: 'Express/Node',
          td: ['`express-openapi-validator`', 'Middleware validates against spec file'],
        },
        {
          th: 'FastAPI/Python',
        ...
        {
          th: 'Rails',
          td: ['`committee`', 'Rack middleware validates against spec'],
        },
        {
          th: 'Go',
          td: ['`kin-openapi`', 'Middleware for Echo, Chi, Gin'],
        },
      ],
    },
