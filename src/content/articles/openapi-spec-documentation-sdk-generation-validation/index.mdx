  ...
  content={{
    ...
    tbody: {
      tr: [
        {
          th: 'Express/Node',
          td: ['<span class="font-mono">express-openapi-validator</span>', 'Middleware validates against spec file'],
        },
        {
          th: 'FastAPI/Python',
          td: ['Built-in with Pydantic', 'Type hints become validation schema'],
        },
        {
          th: 'Rails',
          td: ['<span class="font-mono">committee</span>', 'Rack middleware validates against spec'],
        },
        {
          th: 'Go',
          td: ['<span class="font-mono">kin-openapi</span>', 'Middleware for Echo, Chi, Gin'],
        },
      ],
    },
