...
import decisionFactorsDiagram from "./diagrams/decision-factors-for-infrastructure-choice.png"
import kubernetesFitDiagram from "./diagrams/kubernetes-fit-decision-tree.png"
...
<List
  ...
  items={[
    {
      text: "Intermediate: container fundamentals, Linux systems administration, networking basics (TCP/IP, DNS, load balancing)",
    },
    {
      text: "Basic: YAML proficiency, cloud provider familiarity",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      text: "Intermediate: Kubernetes resource model (pods, deployments, services), kubectl, pod debugging (logs, exec, describe)",
    },
    {
      text: "Basic: Helm or Kustomize, resource requests/limits",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      text: "Intermediate: Kubernetes networking (CNI, services, ingress), storage (PV, PVC, storage classes), RBAC and security, cluster upgrades, monitoring and alerting, troubleshooting distributed systems",
    },
  ]}
/>
