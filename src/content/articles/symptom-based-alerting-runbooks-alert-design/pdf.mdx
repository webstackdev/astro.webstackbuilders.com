...
import theAlertingPyramidDiagram from "./diagrams/the-alerting-pyramid.png"
import theAlertFatigueCycleDiagram from "./diagrams/the-alert-fatigue-cycle.png"

*[MTTA]: Mean Time to Acknowledge
      text: 'The <span class="text-mono">runbook_url</span> annotation must exist.',
  ...
  items={[
    {
      ...
      text: "group_by: ['alertname', 'service'] prevents a cascading failure from generating 50 separate pages. One page with context is better than an inbox flood.",
    },
    {
