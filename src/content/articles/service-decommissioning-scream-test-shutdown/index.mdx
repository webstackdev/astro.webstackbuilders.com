...
<List
  ...
  items={[
    {
      lead: 'All known consumers migrated and confirmed',
    },
    {
      lead: 'Scream test completed without blocking escalations',
    },
    {
      lead: 'Data backup completed and verified',
    },
    {
      lead: 'Rollback plan documented and tested',
    },
    {
      lead: 'Stakeholder sign-off obtained',
    },
    {
      lead: 'Monitoring alerts silenced or removed',
    },
    {
      lead: 'On-call team notified',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: 'Remove from load balancer (stops new traffic)',
    },
    {
      lead: 'Scale deployment to zero replicas',
    },
    {
      lead: 'Update DNS if applicable (point to deprecation page or remove)',
    },
    {
      lead: 'Stop scheduled jobs and cron tasks',
    },
    {
      lead: 'Revoke service account credentials',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: 'Monitor for 24 hours for unexpected errors in dependent services',
    },
    {
      lead: 'Confirm no traffic attempts in logs',
    },
    {
      lead: 'Update service catalog to show decommissioned status',
    },
    {
      lead: 'Update architecture diagrams',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: 'Delete Kubernetes resources',
    },
    {
      lead: 'Archive or delete database (per retention policy)',
    },
    {
      lead: 'Remove CI/CD pipelines',
    },
    {
      lead: "Archive source code repository (don't delete-you might need to reference it)",
    },
    {
      lead: 'Remove monitoring dashboards',
    },
    {
      lead: 'Cancel related cloud resources',
    },
    {
      lead: 'Verify no ongoing charges with FinOps',
    },
  ]}
/>
...
Database archival has a specific workflow that's easy to get wrong. The goal is to ensure data is accessible from the archive __before__ you delete the source.
  ...
  items={[
    {
      ...
      text: 'Include a clear label indicating this is the decommission backup. Use your standard backup tooling so restores work the same way.',
    },
    {
    ...
    },
    {
      ...
      text: 'Document what was archived, where it went, row counts by table, and instructions for accessing the data. Put this manifest somewhere discoverable-a wiki page or the service catalog entry for the decommissioned service.',
    },
    {
      ...
      tr: [
        {
          ...
          td: ['Deleted', '<span class="font-mono">kubectl get deployment $SERVICE</span> returns NotFound'],
        },
        {
          th: 'Kubernetes service',
          td: ['Deleted', '<span class="font-mono">kubectl get service $SERVICE</span> returns NotFound'],
        },
        {
          th: 'Database',
        ...
        {
          th: 'DNS records',
          td: ['Deleted or redirected', '<span class="font-mono">dig $SERVICE.example.com</span> returns NXDOMAIN'],
        },
        {
          th: 'SSL certificates',
  ...
  content={{
    ...
    tbody: {
      tr: [
        ...
        {
          th: '<span class="font-semibold">Total</span>',
          td: ['<span class="font-semibold">$2,150</span>', '<span class="font-semibold">$15</span>', '<span class="font-semibold">$2,135</span>'],
        },
      ],
    },
...
<Download
  resource="service-decommissioning-scream-test-shutdown"
  title="Decommissioning Services: The Art of Turning Off"
  description="Scream tests, traffic analysis, and soft shutdowns for services nobody remembers but everyone depends on."
  listItems={[
    {
      text: "Scream test phase checklist",
    },
    {
      text: "Dependency discovery query pack",
    },
    {
      text: "Safe shutdown rollback plan",
    },
    {
      text: "Decommission communication templates",
    },
  ]}
/>
