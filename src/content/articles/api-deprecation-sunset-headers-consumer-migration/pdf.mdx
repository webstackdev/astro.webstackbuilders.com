...
import ApiDeprecationLifecycle from './api-deprecation-lifecycle-with-parallel-migration-support-track.jpg'
import ConsumerMigrationStatus from './consumer-migration-status-breakdown-for-deprecation-tracking.jpg'
