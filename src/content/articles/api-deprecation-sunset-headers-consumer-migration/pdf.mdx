...
<Table
  ...
  content={{
    ...
    tbody: {
      tr: [
        { th: "Deprecated", td: ["See timeline guidance below", "Announcement, docs update", "Deprecation header"] },
...
<List
  variant="check-icons-list"
  items={[
    { lead: "Consumer identity:", text: "API key, OAuth client ID, or whatever authentication mechanism you use. You need to know who to contact." },
    { lead: "Request volume:", text: "Total requests over the tracking period. High-volume consumers need more attention." },
    { lead: "Endpoint coverage:", text: "Which specific endpoints they use. A consumer using one endpoint is easier to migrate than one using twenty." },
    { lead: "Last seen:", text: "When they last made a request. A consumer who has not called the API in 60 days may have already migrated or abandoned their integration." },
    { lead: "First seen:", text: "When they started using the API. Consumers who adopted recently may be easier to move." },
  ]}
/>
...
<Table
  ...
  content={{
    ...
    tbody: {
      tr: [
        { th: "Deprecated Traffic %", td: ["Overall migration progress", "> 20% at T-30 days"] },
...
<List
  variant="check-icons-list"
  items={[
    { lead: "API key provisioning:", text: "When creating new API keys or OAuth clients, do not grant access to deprecated API versions. The provisioning system should default to the latest stable version." },
    { lead: "Documentation:", text: "Remove the deprecated API from public documentation, or move it to an \"archived\" section with prominent deprecation warnings. New developers should not find the deprecated API when searching for how to integrate." },
    { lead: "SDK distribution:", text: "If you publish SDKs, stop distributing versions that use the deprecated API. Remove them from package managers or mark them as deprecated in the registry metadata." },
    { lead: "Gateway enforcement:", text: "Configure your API gateway to reject requests from API keys created after the deprecation announcement date:" },
  ]}
/>
...
<List
  variant="check-icons-list"
  items={[
    { lead: "Timeline with specific dates:", text: "Not \"Q2 2025\" but \"June 1, 2025.\" Ambiguous dates create confusion and arguments." },
    { lead: "Migration guide link:", text: "The announcement tells consumers what is happening; the guide tells them how to respond." },
    { lead: "Breaking changes summary:", text: "A quick list of what will break. Consumers need to assess migration effort." },
    { lead: "Support contact:", text: "Where to get help. Include both self-service resources and human contact options." },
    { lead: "FAQ for common concerns:", text: "Pre-answer the questions you know consumers will ask." },
  ]}
/>
...
<List
  variant="check-icons-list"
  items={[
    { text: "**Deprecated**: January 15, 2024" },
    { text: "**Sunset**: June 1, 2025" },
    { text: "**Removal**: July 1, 2025" },
  ]}
/>
...
<List
  variant="check-icons-list"
  items={[
    { text: "Authentication moved from API key to OAuth 2.0" },
    { text: "Pagination changed from offset to cursor-based" },
    { text: "Response envelope removed (data no longer wrapped)" },
  ]}
/>
...
<List
  variant="check-icons-list"
  items={[
    { text: "Migration office hours: Thursdays 2-3pm UTC" },
    { text: "Support channel: #api-migration-help" },
    { text: "Direct support: api-support@example.com" },
  ]}
/>
...
<List
  variant="check-icons-list"
  items={[
    { lead: "Blog and changelog reach the broadest audience:", text: "including developers who are evaluating your API but have not yet integrated. They set the public record." },
    { lead: "Email reaches registered consumers directly:", text: "Send the initial announcement, then monthly reminders with updated migration statistics. Include the consumer's own usage data if possible—\"Your API key made 50,000 requests to deprecated endpoints last month\" is more compelling than generic warnings." },
    { lead: "API headers reach consumers who are actively using the deprecated API:", text: "even if they ignore emails. The Deprecation and Sunset headers we discussed earlier serve this purpose." },
    { lead: "Dashboard banners catch consumers when they log in to manage their integration:", text: "A persistent, non-dismissable banner during the final 30 days is appropriate." },
    { lead: "Direct outreach is reserved for high-traffic consumers and the final push before sunset:", text: "This means phone calls, not emails. If a consumer represents 10% of deprecated traffic and has not responded to automated communications, someone needs to call them." },
  ]}
/>
...
<List
  variant="check-icons-list"
  items={[
    { lead: "Technical escalation includes rate limiting, degraded service quality, and eventually hard removal:", text: "These are the consequences that make ignoring deprecation uncomfortable." },
    { lead: "Organizational escalation involves account managers, customer success teams, and potentially executives:", text: "For enterprise customers, the engineering team sending emails is often less effective than their account manager explaining that continued API access is at risk." },
  ]}
/>
...
<List
  variant="check-icons-list"
  items={[
    { lead: "Endpoint mapping tables show every old endpoint, its new equivalent, and what changed:", text: "Developers should be able to look up any v1 endpoint and immediately find the v2 replacement." },
    { lead: "Code examples in multiple languages demonstrate the actual code changes:", text: "If your consumers use JavaScript, Python, and Go, show examples in all three. Abstract descriptions help no one." },
    { lead: "Common pitfalls list the mistakes developers will make and how to avoid them:", text: "You know what these are—you made them yourself when building v2." },
    { lead: "Validation tools let developers verify their migration is correct before switching production traffic:", text: "" },
  ]}
/>
...
<Table
  ...
  content={{
    ...
    tbody: {
      tr: [
        { th: "`GET /v1/users`", td: ["`GET /v2/users`", "Cursor pagination, no envelope"] },
        { th: "`GET /v1/users/:id`", td: ["`GET /v2/users/:id`", "Field renames: `created` → `createdAt`"] },
        { th: "`POST /v1/users`", td: ["`POST /v2/users`", "Request body schema changed"] },
        { th: "`DELETE /v1/users/:id`", td: ["`DELETE /v2/users/:id`", "Now returns 204, not 200 with body"] },
        { th: "`GET /v1/users/:id/orders`", td: ["`GET /v2/orders?userId=:id`", "Moved to orders resource"] },
      ],
    },
  }}
/>
...
<List
  variant="check-icons-list"
  items={[
    { text: "TypeScript/JavaScript: JSDoc `@deprecated` tag (shows in IDE, but no build errors)" },
    { text: "Java: `@Deprecated` annotation with `forRemoval = true`" },
    { text: "Python: `warnings.warn()` with `DeprecationWarning`" },
    { text: "Go: Comment convention `// Deprecated:` (recognized by `staticcheck`)" },
  ]}
/>
...
<List
  variant="check-icons-list"
  items={[
    { lead: "Warning and logging are for you, not consumers.", text: "They establish the paper trail and give you data on who needs to migrate." },
    { lead: "Rate limiting is the first enforcement consumers actually feel.", text: "Their integrations still work, but they work worse. This motivates action without causing outages." },
    { lead: "Read-only mode previews removal.", text: "Consumers discover which parts of their integration will break, but reads still work. This is particularly valuable for consumers who have forgotten they depend on the deprecated API." },
    { lead: "Removal is the final step.", text: "By this point, you have given consumers months of warning and multiple escalations. Anyone still hitting the deprecated API has chosen not to migrate." },
  ]}
/>
...
<List
  variant="check-icons-list"
  items={[
    { lead: "Renegotiate the contract:", text: "Work with your sales or legal team to amend the contract. Offer something in exchange—extended support for the new API, migration assistance, a discount. Many customers will accept a reasonable deal if approached early." },
    { lead: "Create an extended support tier:", text: "Offer continued v1 access as a paid add-on. This shifts the cost of maintenance to the customers who require it and creates a financial incentive to migrate. Price it high enough that migration looks attractive." },
    { lead: "Provide dedicated migration assistance:", text: "Some enterprise customers cannot migrate because they lack engineering resources, not because they lack willingness. Offering to help—whether through documentation, office hours, or direct engineering support—can unblock them." },
    { lead: "Wait it out:", text: "If the contract expires in 6 months and your deprecation timeline is 12 months, you may be able to simply wait. Maintain the deprecated API until the contractual obligation expires, then proceed with removal." },
  ]}
/>
...
<List
  variant="check-icons-list"
  items={[
    { lead: "Extended maintenance windows:", text: "Keep the deprecated API running for specific consumers past the general sunset date. This is expensive but sometimes necessary. Be explicit about the end date—\"We will maintain v1 for your integration until December 31, 2025, after which it will be removed regardless.\"" },
    { lead: "Dedicated migration support:", text: "Assign engineering resources to help the consumer migrate. Pair programming sessions, code reviews of their migration, direct Slack access to your team. Make migration as easy as possible." },
    { lead: "Executive escalation on both sides:", text: "Sometimes the consumer's engineering team wants to migrate but cannot get prioritization from their leadership. Your executive calling their executive can unlock resources." },
  ]}
/>
...
<List
  variant="check-icons-list"
  items={[
    { lead: "URL Path versioning (`/v1/users`, `/v2/users`):", text: "is the most explicit. Versions are visible in every request, easy to route at the gateway level, and cacheable independently. The downside is URL proliferation—you end up with parallel URL hierarchies that can be confusing." },
    { lead: "Header versioning (`Accept: application/vnd.api.v1+json`):", text: "keeps URLs clean but hides the version in headers. This makes debugging harder—you cannot tell from a URL which version a request targets. It also complicates caching since the same URL returns different responses based on headers." },
    { lead: "Query parameter versioning (`?version=1`):", text: "is flexible and visible, but it complicates cache keys and can be accidentally omitted." },
  ]}
/>
...
<List
  variant="check-icons-list"
  items={[
    { lead: "Version at the API level, not the endpoint level:", text: "Consumers should interact with a single API version at a time. Mixed-version integrations (calling some v1 endpoints and some v2 endpoints simultaneously) are fragile and complicate migration tracking." },
    { lead: "Plan for at least two live versions:", text: "Your infrastructure should support running the current version and the previous version in parallel. This gives consumers a migration runway while you develop the next version." },
    { lead: "Document version differences incrementally:", text: "Every time you add to v2 something that differs from v1, document the change immediately. Waiting until deprecation to write migration docs means reconstructing months of changes from memory and commit logs." },
    { lead: "Automate version routing:", text: "Your API gateway should route requests to the correct backend based on version. Manual routing or application-level version switching creates operational burden during deprecation." },
  ]}
/>
...
<List
  variant="check-icons-list"
  items={[
    { lead: "Deprecated traffic percentage:", text: "is your primary metric. Track it weekly and plot the trend. A healthy deprecation shows steady decline. If the percentage is flat or rising, something is wrong—either consumers are not migrating, or new consumers are adopting the deprecated API despite your blocks." },
    { lead: "Consumer migration rate:", text: "tracks how many distinct consumers have completed migration, regardless of their traffic volume. A small number of high-traffic consumers can dominate your traffic metrics while dozens of smaller consumers remain unmigrated. Track both." },
    { lead: "Support ticket volume:", text: "indicates whether your migration documentation and tooling are working. A spike in tickets suggests confusion or missing documentation. A steady decline suggests consumers are self-serving their migrations successfully." },
    { lead: "Migration incidents:", text: "track problems caused by the migration itself—consumers who migrated but hit bugs, performance regressions, or unexpected behavior differences. Zero P1 incidents is the goal. Any P1 incident during migration erodes trust and slows adoption." },
  ]}
/>
...
<List
  variant="check-icons-list"
  items={[
    { text: "Planned sunset: June 1, 2025" },
    { text: "Actual removal: August 15, 2025" },
    { text: "Delay reason: 3 enterprise customers required extended migration support" },
  ]}
/>
...
<List
  variant="check-icons-list"
  items={[
    { text: "Early direct outreach to top 20 consumers by traffic" },
    { text: "Migration office hours for live support" },
    { text: "Endpoint mapping table reduced support tickets" },
  ]}
/>
...
<List
  variant="check-icons-list"
  items={[
    { text: "Initial 6-month timeline too short for enterprise customers" },
    { text: "SDK deprecation warnings not visible enough" },
    { text: "Rate limiting escalation started too late" },
  ]}
/>
...
<List
  variant="check-icons-list"
  items={[
    { text: "Start with 12-month timeline for external APIs" },
    { text: "Add SDK deprecation warnings at compile time, not runtime" },
    { text: "Begin rate limiting at T-90 days, not T-30 days" },
  ]}
/>
```
...
<List
  variant="check-icons-list"
  items={[
    { lead: "Communicate early and often.", text: "One email is not enough. Multiple channels, repeated over months, with increasing urgency. Make it impossible for consumers to claim they did not know." },
    { lead: "Track usage obsessively.", text: "You cannot manage what you do not measure. Know exactly who is using the deprecated API, how much traffic they send, and whether they are making progress on migration." },
    { lead: "Enforce gradually but firmly.", text: "Soft warnings escalate to rate limits escalate to removal. Each step gives consumers a chance to respond, but the consequences are real and the timeline is non-negotiable." },
    { lead: "Plan for the consumers who will not move voluntarily.", text: "Some consumers will not migrate until it hurts. Build your escalation path assuming resistance, and you will be pleasantly surprised when consumers migrate early." },
  ]}
/>
