...
<Table
  variant="vertical-column-delineation-table"
  content={{
    figure: "Graduated enforcement progression.",
...
<List
  variant="check-icons-list"
  items={[
    { lead: "T-90 days:", text: "Send email warning. Update documentation. Add deprecation headers." },
    { lead: "T-60 days:", text: "Direct outreach to top consumers by traffic. Monthly reminder email." },
    { lead: "T-30 days:", text: "Bring in account managers for enterprise customers. Begin rate limiting." },
    { lead: "T-14 days:", text: "Final warning. Aggressive rate limiting." },
    { lead: "T-7 days:", text: "Last chance communication. Minimal rate limits." },
    { lead: "Sunset:", text: "Return 410 Gone." },
  ]}
/>
