...
<List
  ...
  items={[
    ...
    { text: "Goodput vs. throughput: why systems can look busy while being useless" },
    { text: "Load shedding and admission control: gracefully rejecting requests when over capacity" },
    { text: "Backpressure signaling: communicating overload across service boundaries (HTTP 503, gRPC flow control)" },
    { text: "Timeout tuning and priority queues: preventing cascades while protecting critical traffic" },
    { text: "Monitoring and real-world case studies: detecting overload early and recovering gracefully" },
  ]}
/>
