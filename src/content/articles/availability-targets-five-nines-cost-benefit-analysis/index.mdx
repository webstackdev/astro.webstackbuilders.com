...
<Table
  ...
  content={{
    figure: "Availability percentages translated to actual downtime windows.",
    thead: { th: ["Availability", "Annual Downtime", "Monthly Downtime", "Weekly Downtime"] },
    tbody: {
      tr: [
        {
          th: "99% (two nines)",
          td: ["87.6 hours", "7.31 hours", "1.68 hours"],
        },
        {
          th: "99.9% (three nines)",
          td: ["8.77 hours", "43.83 minutes", "10.08 minutes"],
        },
        {
          th: "99.95%",
          td: ["4.38 hours", "21.92 minutes", "5.04 minutes"],
        },
        {
          th: "99.99% (four nines)",
          td: ["52.60 minutes", "4.38 minutes", "1.01 minutes"],
        },
        {
          th: "99.999% (five nines)",
          td: ["5.26 minutes", "26.30 seconds", "6.05 seconds"],
        },
      ],
    },
  }}
...
<Table
  ...
  content={{
    figure: "Infrastructure cost multipliers by availability tier.",
    thead: { th: ["Tier", "Typical Architecture", "Relative Cost"] },
    tbody: {
      tr: [
        {
          th: "99%",
          td: ["Single region, basic monitoring", "1x (baseline)"],
        },
        {
          th: "99.9%",
          td: ["Multi-AZ, load balancing, automated recovery", "2-3x"],
        },
        {
          th: "99.95%",
          td: ["Active-passive DR, comprehensive monitoring", "4-6x"],
        },
        {
          th: "99.99%",
          td: ["Multi-region active-active, global load balancing", "10-20x"],
        },
        {
          th: "99.999%",
          td: ["Exotic redundancy, zero-downtime everything", "50-100x+"],
        },
      ],
    },
  }}
...
<Table
  ...
  content={{
    figure: "Hidden costs that increase with availability targets.",
    thead: { th: ["Cost Category", "Why It Scales", "Example"] },
    tbody: {
      tr: [
        {
          th: "Engineering Time",
          td: ["More complex systems require more expertise", "Senior SREs vs. junior ops"],
        },
        {
          th: "Testing",
          td: ["More failure modes to validate", "Chaos engineering programs"],
        },
        {
          th: "On-Call",
          td: ["Tighter response requirements", "24/7 staffing vs. best-effort"],
        },
        {
          th: "Tooling",
          td: ["Better observability needed", "$50k/year APM vs. free tier"],
        },
        {
          th: "Opportunity Cost",
          td: ["Time not spent on features", "Every hour on HA is not on product"],
        },
      ],
    },
  }}
...
<Diagram
  src={basicCostBenefitDiagram}
  title="Basic cost-benefit decision for availability investment"
  description="Left-to-right flowchart showing a simple economic decision process. Cost of Downtime and Cost of Prevention both feed into a Compare decision point. That leads to a second decision asking whether Prevention is less than Downtime. If yes, the outcome is Invest in Availability. If no, the outcome is Accept Current Level. The diagram reduces the availability target debate to an economic comparison between avoided loss and the cost of achieving the improvement."
/>
...
<Table
  variant="criteria-highlight-table"
  content={{
    figure: "Same availability number can mean very different user experiences.",
    thead: { th: ["Downtime Type", "User Impact", "Availability Impact"] },
    tbody: {
      tr: [
        {
          th: "3am maintenance (low traffic)",
          td: ["Minimal", "Same as peak hours"],
        },
        {
          th: "Peak hour outage",
          td: ["Severe", "Same as off-hours"],
        },
        {
          th: "Degraded performance",
          td: ["Moderate", "Often not counted"],
        },
        {
          th: "Partial outage (one feature)",
          td: ["Varies", "Depends on measurement"],
        },
      ],
    },
  }}
...
<Table
  variant="grid-and-accent-header-table"
  content={{
    figure: "Different user segments have different availability expectations.",
    thead: { th: ["User Segment", "Acceptable Unavailability", "Reason"] },
    tbody: {
      tr: [
        {
          th: "Consumer app",
          td: ["~30 min/month (99.9%)", "Will retry, has alternatives"],
        },
        {
          th: "Business tool",
          td: ["~5 min/month (99.99%)", "Productivity impact"],
        },
        {
          th: "Financial trading",
          td: ["Seconds/year (99.999%+)", "Every second costs money"],
        },
        {
          th: "Life safety systems",
          td: ["Near-zero", "Lives at stake"],
        },
      ],
    },
  }}
...
<List
  ...
  items={[
    {
      lead: "Payment gateway (external):",
      text: "99.95% SLA, blocking — checkout fails without it",
    },
    {
      lead: "Inventory service (internal):",
      text: "99.9% SLO, blocking — can't sell what you can't verify",
    },
    {
      lead: "Email service (internal):",
      text: "99.5% SLO, non-blocking — can queue and retry confirmations later",
    },
    {
      lead: "Analytics (internal):",
      text: "99% SLO, non-blocking — fire and forget",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      text: "Single region, single availability zone acceptable",
      color: "bg-success",
    },
    {
      text: "Basic load balancing (can be DNS-based)",
      color: "bg-success",
    },
    {
      text: "Single database with backup/restore",
      color: "bg-success",
    },
    {
      text: "Manual intervention expected during failures",
      color: "bg-success",
    },
    {
      text: "On-call response time: hours acceptable",
      color: "bg-success",
    },
  ]}
/>
...
<Diagram
  src={threeNinesDiagram}
  title="Three-nines architecture with multi-AZ deployment"
  description="Flowchart showing a multi-availability-zone design for roughly 99.9 percent availability. Users connect to a Load Balancer that distributes traffic across App Server 1 in AZ1, App Server 2 in AZ2, and App Server 3 in AZ3. All application servers connect to a Primary DB in AZ1, which replicates to a Replica DB in AZ2. The diagram illustrates added resilience through zonal distribution, automated failover potential, and database replication within a single region."
/>
...
<List
  ...
  items={[
    {
      text: "Multi-availability zone deployment",
      color: "bg-success",
    },
    {
      text: "Database replication with automated failover",
      color: "bg-success",
    },
    {
      text: "Health checks and automated instance replacement",
      color: "bg-success",
    },
    {
      text: "Comprehensive monitoring and alerting",
      color: "bg-success",
    },
    {
      text: "On-call response time: minutes required",
      color: "bg-success",
    },
  ]}
/>
...
<List
  ...
  items={[
    ...
    {
      text: "Global load balancing with health-based routing",
      color: "bg-success",
    },
    {
      text: "Cross-region database replication",
      color: "bg-success",
    },
    {
      text: "Automated regional failover",
      color: "bg-success",
    },
    {
      text: "Zero-downtime deployments required",
      color: "bg-success",
    },
    {
      text: "24/7 on-call with <15 minute response",
      color: "bg-success",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      text: "Active-active multi-region (not failover, simultaneous)",
      color: "bg-success",
    },
    {
      text: "No single points of failure anywhere",
      color: "bg-success",
    },
    {
      text: "Sub-second automated recovery",
      color: "bg-success",
    },
    {
      text: "Chaos engineering as standard practice",
      color: "bg-success",
    },
    {
      text: "Dedicated reliability engineering team",
      color: "bg-success",
    },
    {
      text: "Feature velocity sacrificed for stability",
      color: "bg-success",
    },
  ]}
/>
...
<Table
  variant="criteria-highlight-table"
  content={{
    figure: "Availability options with total annual cost (infrastructure + people + tooling + opportunity cost).",
    thead: { th: ["Option", "Availability", "Annual Downtime", "Total Cost", "Best For"] },
    tbody: {
      tr: [
        {
          th: "A",
          td: ["99.9%", "8.77 hours", "$50k/year", "Most SaaS products"],
        },
        {
          th: "B",
          td: ["99.95%", "4.38 hours", "$120k/year", "B2B with SLA requirements"],
        },
        {
          th: "C",
          td: ["99.99%", "52 minutes", "$400k/year", "Critical business systems"],
        },
        {
          th: "D",
          td: ["99.999%", "5 minutes", "$2M+/year", "Financial, healthcare"],
        },
      ],
    },
  }}
...
<List
  ...
  items={[
    {
      lead: "Revenue doesn't justify it",
      text: "Calculate downtime hours saved multiplied by revenue per hour. If this is less than the cost, the math doesn't work.",
    },
    {
      lead: "Dependencies don't support it",
      text: "\"We cannot exceed our payment provider's 99.95%\" is a constraint, not an excuse. Show the composite availability math.",
    },
    {
      lead: "Team can't sustain it",
      text: "24/7 on-call requires 4-5 engineers minimum for a sustainable rotation. Burnout is a reliability risk too.",
    },
    {
      lead: "Better alternatives exist",
      text: "\"We could improve from 99.9% to 99.95% for $70k, or add Feature X for $70k. Which creates more value?\"",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: "Context",
      text: "What triggered the discussion? Was it a customer request, a competitive claim, an outage, or a planning exercise?",
    },
    {
      lead: "Business impact analysis",
      text: "What's the actual revenue at risk during downtime? What's current availability and what does that cost?",
    },
    {
      lead: "Options considered",
      text: "Present at least three tiers with their downtime, lost revenue, infrastructure cost, and net cost. Make the tradeoffs explicit.",
    },
    {
      lead: "Dependency constraints",
      text: "What's the maximum achievable given external dependencies? This often eliminates options immediately.",
    },
    {
      lead: "Decision and rationale",
      text: "State the chosen target and _why_. \"99.99% is not achievable given our payment gateway's 99.95% SLA\" is more useful than \"we chose 99.9%.\"",
    },
    {
      lead: "Approvals",
      text: "Get sign-off from engineering leadership, product, and ideally finance. Availability targets are business decisions, not just technical ones.",
    },
  ]}
/>
...
<Download
  resource="availability-targets-five-nines-cost-benefit-analysis"
  title="Download the Availability Cost-Benefit Guide"
  description="Get the complete framework for evaluating availability targets with ROI math, dependency limits, and pragmatic investment tiers."
  listItems={[
    {
      text: "Availability ROI calculation templates",
    },
    {
      text: "Composite dependency math workbook",
    },
    {
      text: "Tiered architecture cost models",
    },
    {
      text: "Executive decision briefing framework",
    },
  ]}
/>
