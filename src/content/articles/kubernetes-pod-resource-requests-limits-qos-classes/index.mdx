...
<List
  ...
  items={[
    {
      lead: 'Guaranteed',
      text: 'is the highest priority. Every container must have requests and limits set for both CPU and memory, and requests must equal limits. These pods are evicted last.',
    },
    {
      lead: 'Burstable',
