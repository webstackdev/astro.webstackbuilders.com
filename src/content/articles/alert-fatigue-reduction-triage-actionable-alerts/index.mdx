    ...
    tbody: {
      tr: [
        ...
        },
        {
          ...
          td: ['20-80%', 'Investigate thresholds, consider aggregation'],
        },
        {
          th: {
            label: 'Useless',
          ...
          td: ['&lt; 20%', 'Delete or convert to dashboard metric'],
        },
        {
          th: {
            label: 'Stale',
          ...
          td: ['Not fired in 3+ months', 'Review for deletion'],
        },
      ],
    },
  }}
