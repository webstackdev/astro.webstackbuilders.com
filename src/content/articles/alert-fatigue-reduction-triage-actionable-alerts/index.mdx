...
tags: ["reliability-and-testing", "prometheus"]
featured: true
---

import alertOutcomeDiagram from './diagrams/alert-outcome-tracking-for-health-metrics.jpg'
import decisionTreeDiagram from './diagrams/decision-tree-for-page-vs-notification-classification.jpg'
...
<List
  ...
  items={[
    ...
    },
    {
      icon: "chart",
      lead: "Action rate",
      text: "Percentage of alerts that required human intervention beyond acknowledgment. Below 50% means more than half your alerts are noise.",
    },
    {
      icon: "chart-line",
      lead: "MTTA trend",
      text: "Is acknowledgment time increasing? That's a leading indicator of fatigue.",
    },
    {
      icon: "on-call",
      lead: "On-call satisfaction",
      text: "Periodic surveys. Engineers will tell you when on-call is unsustainable if you ask.",
    },
  ]}
/>
...
<Table
  ...
  content={{
    figure: "Alert inventory fields for the audit process.",
    thead: { th: ["Field", "Description", "Why It Matters"] },
    tbody: {
      tr: [
        {
          th: "Alert Name",
          td: [
            "Identifier in monitoring system",
        ...
        },
        {
          th: "Action Rate",
          td: [
            "% of firings requiring human action",
            "Core signal for usefulness",
          ],
        },
        {
          th: "Owning Team",
...
<List
  ...
  items={[
    {
      lead: '"This alert fired 47 times last quarter. How many of those were real problems?"',
      text: '(Usually: zero or one.)',
    },
    {
      lead: '"Would you notice if this alert stopped firing tomorrow?"',
      text: '(Usually: no.)',
    },
    {
      lead: '"If we delete this, what\'s the worst case?"',
      text: "(Usually: we'd notice the problem some other way, slightly later.)",
    },
  ]}
/>
  ...
  items={[
    {
      ...
      text: "Not \"might break soon\" or \"is trending toward a problem.\" Actually broken."
    },
    {
      lead: "Users are affected.",
      text: "Either external customers or internal users who can't do their jobs."
    },
    {
      lead: "Human judgment is required.",
      text: "Automated remediation can't handle it, or hasn't been implemented yet."
    },
  ]}
/>
...
<Table
  ...
  classes={{
    thead: "text-center",
    tbody: "text-content text-center",
  }}
  content={{
    figure: "Page vs. notification decision matrix.",
    thead: { th: ["Criterion", "Page", "Notification"] },
    tbody: {
      tr: [
        { th: "User-facing functionality down", td: ["✅", ""] },
        { th: "SLO error budget exhausted", td: ["✅", ""] },
        { th: "Security incident in progress", td: ["✅", ""] },
        { th: "Capacity threshold (proactive)", td: ["", "✅"] },
        { th: "Background job failure", td: ["", "✅"] },
        { th: "Non-critical dependency degraded", td: ["", "✅"] },
      ],
    },
  }}
/>
  ...
  items={[
    {
      icon: "network",
      color: "page-inverse",
      text: "Network partition alerts suppress all cross-zone communication failures",
    },
    {
      icon: "load-balancer",
      color: "page-inverse",
      text: "Load balancer alerts suppress backend health check failures",
    },
    {
      icon: "dns",
      color: "page-inverse",
      text: "DNS alerts suppress all hostname resolution failures",
    },
    {
      icon: "cloud",
      color: "page-inverse",
      text: "Cloud provider alerts suppress regional service alerts",
    },
  ]}
/>
...
&nbsp;&nbsp;SLO target: 99.9% (0.1% error budget)<br />
&nbsp;&nbsp;Current error rate: 0.5%<br />
&nbsp;&nbsp;Burn rate: 0.5% / 0.1% = 5x<br />
...
<Table
  ...
  content={{
    figure: "Multi-window burn rate thresholds for a 99.9% SLO.",
    thead: { th: ["Window", "Burn Rate", "Catches"] },
    tbody: {
      tr: [
        { th: "5m", td: ["14.4x", "Acute incidents, sudden failures"] },
        { th: "1h", td: ["6x", "Sustained degradation"] },
        { th: "6h", td: ["1x", "Slow-burn issues"] },
      ],
    },
  }}
/>
...
<List
  variant="numbered-with-background-list"
  items={[
    { lead: "What does this alert mean?", text: "One paragraph explaining the symptom in user terms." },
    { lead: "What should I check first?", text: "Three to five diagnostic commands or dashboard links." },
    { lead: "Who do I escalate to?", text: "Contact information for specialized help." },
    { lead: "Can I roll back?", text: "If applicable, the exact rollback command." },
  ]}
/>
...
<List
  ...
  items={[
    { lead: "What's happening", text: "the symptom in plain language" },
    { lead: "Where it's happening", text: "environment, region, service" },
    { lead: "How bad it is", text: "current metric values" },
    { lead: "Where to look", text: "direct links to relevant dashboards" },
    { lead: "What to do", text: "link to the runbook" },
  ]}
/>
...
<Table
  variant="numbered-review-table"
  content={{
    figure: "Alert maintenance review cadence.",
    thead: { th: ["Review Type", "Frequency", "Questions"] },
    tbody: {
      tr: [
        {
          th: "Firing Review",
          td: ["Monthly", "Which alerts fired most? What was the action rate?"],
        },
        {
          th: "Usefulness Review",
          td: ["Quarterly", "Do we still need this alert? Is the threshold still valid?"],
        },
        {
          th: "Runbook Review",
          td: ["Quarterly", "Is the runbook current? Did it help in recent incidents?"],
        },
        {
          th: "Owner Review",
          td: ["Annually", "Does the owning team still exist? Do they still own this service?"],
        },
      ],
    },
  }}
...
<List
  variant="check-icons"
  items={[
    { text: "Saturate CPU or memory to test resource alerts" },
    { text: "Return 500 errors from a canary endpoint to test error rate alerts" },
    { text: "Add artificial latency to test SLO burn rate alerts" },
    { text: "Take down a dependency to test downstream failure alerts" },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: 'Action rate:',
      text: 'The percentage of alerts that result in human action, such as creating an incident, making a change, or escalating to another team. An 80% action rate means 80% of alerts were worth investigating. Below 50%, most of your alerts are noise.',
    },
    {
      lead: 'Mean Time to Acknowledge (MTTA):',
      text: 'Measures how long it takes someone to start responding to an alert. High MTTA indicates either too many alerts (responders are overwhelmed) or poor alert routing (alerts going to the wrong people).',
    },
    {
      lead: 'Alerts per on-call shift:',
      text: 'Counts the total alert volume during a rotation. More than 25 alerts per shift usually means someone is getting paged multiple times per hour, which is unsustainable.',
    },
    {
      lead: 'On-call satisfaction:',
      text: 'A subjective measure, but it matters. Survey your on-call rotation quarterly. If satisfaction is low, your alerting needs work regardless of what the other metrics say.',
    },
  ]}
/>
...
<Diagram
  src={alertOutcomeDiagram}
  title="Alert outcome tracking for health metrics"
  magnifyButtonPosition="bottom-right"
  description="Flowchart showing how alert outcomes are categorized for health metrics. The process starts with Alert Fires, then moves to a decision point labeled Action Taken?. If the answer is Yes, the alert leads to Incident Created, then Resolution, and finally Post-Incident Review. If the answer is No, the alert is classified as Noise, which then feeds into Alert Audit Candidate. The diagram distinguishes between alerts that produced meaningful operational work and alerts that should be reviewed as likely noise."
/>
...
<Table
  ...
  content={{
    figure: "Alert health metric thresholds.",
    thead: { th: ["Metric", "Healthy", "Warning", "Critical"] },
    tbody: {
      tr: [
        { th: "Action Rate", td: ["> 80%", "50-80%", "< 50%"] },
        { th: "MTTA", td: ["< 5 min", "5-15 min", "> 15 min"] },
        { th: "Alerts per On-Call Shift", td: ["< 10", "10-25", "> 25"] },
        { th: "On-Call Satisfaction", td: ["> 7/10", "5-7/10", "< 5/10"] },
      ],
    },
  }}
/>
