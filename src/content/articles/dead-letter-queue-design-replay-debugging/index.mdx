...
<Table
  ...
  content={{
    ...
    tbody: {
      tr: [
        {
          th: { label: "Same queue system (SQS, RabbitMQ)", color: "secondary" },
          td: [
        ...
        {
          th: { label: "Database (PostgreSQL)", color: "success" },
          td: [
        ...
        {
          th: { label: "Document store (MongoDB)", color: "info" },
          td: [
        ...
        {
          th: { label: "Time-series (Elasticsearch)", color: "warning" },
          td: [
...
<Download
  resource="dead-letter-queue-design-replay-debugging"
  title="Download the DLQ Design Guide"
  description="Get the complete dead-letter handling playbook for failure classification, replay safety, and query-driven triage workflows."
  listItems={[
    {
      text: "Failure taxonomy decision matrix",
    },
    {
      text: "Context capture field checklist",
    },
    {
      text: "Replay safety validation runbook",
    },
    {
      text: "DLQ triage workflow templates",
    },
  ]}
/>
