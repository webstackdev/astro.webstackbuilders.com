...
import csiDriverDiagram from "./diagrams/csi-driver-secret-fetch-flow.png"
import esoSyncDiagram from "./diagrams/eso-sync-flow.png"
import patternDecisionDiagram from "./diagrams/pattern-decision-tree.png"
import threeSecretDiagram from "./diagrams/three-secret-injection-patterns.png"
...
<List
  ...
  items={[
    {
      lead: 'External Secrets Operator',
      text: 'syncs secrets on a schedule and caches them as native Kubernetes secrets.',
    },
    {
      lead: 'Secrets Store CSI Driver',
      text: 'fetches secrets on-demand when pods start.',
    },
    {
      lead: 'Init containers',
      text: 'give you complete control but require you to implement everything yourself.',
    },
  ]}
/>
...
<List
  ...
  items={[
    ...
    {
      lead: 'Init containers',
      text: 'fit edge cases where ESO and CSI don\'t provide enough control. Legacy applications that need secrets in unusual formats, multi-source fallback logic, or integration with systems that don\'t have ESO/CSI providers. You\'re writing and maintaining the logic yourself.',
    },
    {
      lead: 'Native secrets',
      text: 'fit non-sensitive configuration and development environments. With encryption at rest configured, they\'re acceptable for data that doesn\'t require rotation or audit trails.',
    },
  ]}
/>
