...
<Download
  resource="nginx-haproxy-reverse-proxy-production-tuning"
  title="Reverse Proxy Hardening: Timeouts, Buffers, Defaults"
  description="Why default nginx and HAProxy configurations fail under load and how to tune them for production."
  listItems={[
    {
      text: "Timeout baseline tuning matrix",
    },
    {
      text: "Buffer sizing troubleshooting guide",
    },
    {
      text: "Connection pool optimization checklist",
    },
    {
      text: "Proxy metrics alerting pack",
    },
  ]}
/>
