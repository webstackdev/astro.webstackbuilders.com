...
import connectionPoolingDiagram from "./diagrams/connection-pooling-to-backends.png"
import nginxTimeoutDiagram from "./diagrams/nginx-timeout-chain.png"
import requestFlowDiagram from "./diagrams/request-flow-through-reverse-proxy.png"
