...
This is the gap between GitOps theory and operational reality. <Highlighter>When sync fails, you need to understand what ArgoCD is actually doing underneath the abstraction.</Highlighter>
...
<Table
  ...
  content={{
    figure: "Common sync wave ordering pattern.",
...
<List
  variant="badge-list"
  classes={{
    titleClass: "sm:float-right",
    content: "sm:relative sm:-top-1",
  }}
  items={[
    {
      title: "OutOfSync + Healthy:",
      text: "Drift problem — something's modifying the resource after ArgoCD applies it",
    },
    {
      title: "Degraded:",
      text: "Something failed to start — check pod events",
    },
    {
      title: "Progressing for a long time:",
      text: "Something's stuck — likely a hook or slow rollout",
    },
  ]}
/>
...
<Table
  ...
  content={{
    figure: "Common ArgoCD sync failure patterns with quick fixes.",
    thead: { th: ["Pattern", "Symptom", "Likely Cause", "Quick Fix"] },
    tbody: {
      tr: [
        {
          th: "Stuck on hook",
          td: [
            '"Running PreSync hooks" forever',
            "Hook Job not completing",
            'Check job logs, add <span class="font-mono">activeDeadlineSeconds</span>',
          ],
        },
        {
          th: "OutOfSync loop",
          td: [
            ...
            'Add <span class="font-mono">ignoreDifferences</span> for that field',
          ],
        },
        {
          th: "Missing resource",
