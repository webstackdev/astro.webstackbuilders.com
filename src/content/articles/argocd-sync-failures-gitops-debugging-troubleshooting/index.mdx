...
import argocdSyncDiagram from "./diagrams/argocd-sync-process-from-git-commit-to-healthy-application_article.jpg"
...
<List
  ...
  items={[
    ...
    {
      lead: "Progressing for a long time:",
      ...
      tr: [
        {
          ...
          td: [
            ...
            "Check job logs, add `activeDeadlineSeconds`",
          ],
        },
        {
          th: "OutOfSync loop",
