...
<List
  ...
  items={[
    { lead: "OutOfSync + Healthy:", text: "Drift problem—something's modifying the resource after ArgoCD applies it" },
    { lead: "Degraded:", text: "Something failed to start—check pod events" },
    { lead: "Progressing for a long time:", text: "Something's stuck—likely a hook or slow rollout" },
  ]}
/>
...
<Table
  ...
  content={{
    ...
    tbody: {
      tr: [
        { th: "Stuck on hook", td: ["\"Running PreSync hooks\" forever", "Hook Job not completing", "Check job logs, add `activeDeadlineSeconds`"] },
        { th: "OutOfSync loop", td: ["Syncs successfully, immediately OutOfSync", "Controller modifying resource", "Add `ignoreDifferences` for that field"] },
        { th: "Missing resource", td: ["\"secret X not found\"", "Dependency ordering", "Move dependency to earlier sync wave"] },
        { th: "CRD not found", td: ["\"server doesn't have resource type\"", "CRD applied too late", "Put CRD in wave -5"] },
      ],
    },
  }}
/>
