...
import argocdHealthDiagram from "./diagrams/argocd-health-assessment-flow-for-different-resource-types.png"
import argocdSyncDiagram from "./diagrams/argocd-sync-process-from-git-commit-to-healthy-application_deep-dive.png"
import hookExecutionDiagram from "./diagrams/hook-execution-sequence-during-argocd-sync-lifecycle.png"
import outofsyncLoopDiagram from "./diagrams/outofsync-loop-caused-by-external-modifications-to-resources.png"
import resourceDependencyDiagram from "./diagrams/resource-dependency-graph-showing-potential-failure-points.png"
...
<List
  ...
  items={[
    {
      text: "Pod stuck in `CreateContainerConfigError`",
    },
    {
...
<List
  ...
  items={[
    ...
    },
    {
      ...
      text: "that adds fields your manifest doesn't specify (like `imagePullPolicy: IfNotPresent`)",
    },
    {
