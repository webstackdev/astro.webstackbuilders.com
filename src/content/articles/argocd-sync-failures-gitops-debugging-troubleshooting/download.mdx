...
<List
  ...
  items={[
    ...
    { text: "Debugging techniques: reading sync logs, understanding resource status, tracing hook execution" },
    { text: "Common failure modes and their recognition patterns" },
    { text: "The mental model behind ArgoCD's behavior to reason about failures" },
    { text: "Real examples of production sync failures and how they were resolved" },
  ]}
/>
