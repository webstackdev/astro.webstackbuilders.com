...
tags: ["platform-engineering","backstage-idp","terraform","kubernetes","aws"]
featured: true
---
...
<Download
  resource="internal-developer-portal-platform-self-service-actions"
  title="Download the Internal Developer Platform Guide"
  description="Get the complete self-service platform playbook for actionable portals, workflow automation, and policy-based approvals."
  listItems={[
    {
      text: "Portal maturity assessment framework",
    },
    {
      text: "Self-service action design patterns",
    },
    {
      text: "Approval routing policy templates",
    },
    {
      text: "Platform adoption metrics playbook",
    },
  ]}
/>
