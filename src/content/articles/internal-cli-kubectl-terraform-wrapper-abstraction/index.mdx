...
<Highlighter>The question isn't whether you _can_ build a wrapper - it's whether you _should_.</Highlighter> And if you do, how do you build it in a way that doesn't become a liability?
...
<List
  ...
  items={[
    ...
    {
      lead: "Guard rails",
      text: "Prevents dangerous operations. A `kubectl-safe` wrapper that blocks `delete` in production without an approval ticket prevents the kind of outages that make the news. This works when the underlying tool allows dangerous operations with severe consequences and the policy can be codified clearly.",
    },
    {
      ...
      tr: [
        {
          ...
          td: ["Consider wrapping", "Use scripts or docs"],
        },
        {
...
<List
  ...
  items={[
    {
      lead: 'Explicit flags',
      text: '<span class="font-mono">--context=prod</span>',
    },
    {
      lead: 'Environment variables',
      text: '<span class="font-mono">DEPLOY_ENV=staging</span>',
    },
    {
      lead: 'Git branch detection',
      text: '<span class="font-mono">main</span> → production',
    },
    {
      lead: 'Directory structure',
      text: '<span class="font-mono">/environments/dev/</span>',
    },
    {
      lead: 'Default fallback',
      text: 'Usually dev',
    },
  ]}
/>
  ...
  content={{
    ...
    tbody: {
      tr: [
        {
          th: "Bypass rate",
          td: ["Below 10%", "10-20%", "Above 20%"],
        },
        {
          th: "Version lag",
          td: ["Current", "1 minor", "1+ major"],
        },
        {
          th: "Monthly active users",
          td: ["Stable/growing", "Declining 10%", "Declining 25%+"],
        },
        {
          th: "Support tickets per user",
          td: ["Decreasing", "Flat", "Increasing"],
        },
      ],
    },
  }}
