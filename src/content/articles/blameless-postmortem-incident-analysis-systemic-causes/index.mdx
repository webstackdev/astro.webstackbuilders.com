...
import multipleContributingInterventionDiagram from "./diagrams/multiple-contributing-factors-each-representing-a-potential-intervention-point.png"
...
<List
  ...
  items={[
    {
      lead: "Human error:",
      text: "is inadvertent — a typo, a misremembered procedure. The response is system improvement.",
    },
    {
    ...
    },
    {
      ...
      text: "is conscious disregard of a known substantial risk — genuinely rare in professional settings and the only category where punitive action may be appropriate.",
    },
  ]}
/>
