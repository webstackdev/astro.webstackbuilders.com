...
<Table
  ...
  classes={{
    figure: "sm:ml-12 sm:mr-12 mb-6",
  }}
  content={{
    figure: "Blame-based vs. systemic approaches to incident analysis.",
...
<List
  ...
  items={[
    {
      lead: "Would I have made the same decision with the same information they had?",
    },
    {
      lead: "What would have had to be different for this to be a success story instead of an incident?",
    },
    {
      lead: "How many times has this exact action been taken without incident?",
    },
  ]}
/>
...
<Table
  ...
  content={{
    figure: "Clarifying what blameless culture actually means.",
    thead: { th: ["What Blameless IS", "What Blameless IS NOT"] },
    tbody: {
      tr: [
        {
          th: "Holding systems accountable",
          td: ["Letting individuals off the hook"],
        },
        {
          th: "Safe to report errors",
          td: ["Safe to be negligent"],
        },
        {
          th: "Learning from mistakes",
          td: ["Ignoring mistakes"],
        },
        {
          th: "Improving processes",
          td: ["Accepting poor processes"],
        },
        {
          th: "Psychological safety",
          td: ["Lack of standards"],
        },
      ],
    },
  }}
...
<List
  ...
  items={[
    {
      lead: "Human error",
      text: "Inadvertent — the person didn't intend the outcome and didn't consciously take a risk. A typo, a misremembered procedure, a slip of the mouse. The appropriate response is to support the person (they feel bad already) and improve the system so the error is harder to make or causes less damage.",
    },
    {
      lead: "At-risk behavior",
      text: "Involves conscious choice, but the person doesn't fully appreciate the risk. An engineer skipping a checklist step because \"it's always fine\" or deploying without testing because \"the change is trivial.\" The response is coaching and removing the incentives that encouraged the shortcut — often time pressure or inconvenient tools.",
    },
    {
      lead: "Reckless behavior",
      text: "Conscious disregard of a substantial and known risk. This is genuinely rare in professional settings. Someone who intentionally disables safety controls knowing it could cause an outage, not because they misjudged the risk, but because they didn't care. Remedial or punitive action may be appropriate here — but most incidents don't involve reckless behavior.",
    },
  ]}
/>
...
<Table
  ...
  content={{
    figure: "Just Culture behavior categories with appropriate responses.",
...
<List
  ...
  classes={{
    wrapper: "sm:ml-8 sm:mr-12 mb-8",
  }}
  items={[
    {
      text: "Use UTC timestamps consistently",
      color: "bg-secondary",
    },
    {
      text: "Include what people were thinking, not just doing",
      color: "bg-accent",
    },
    {
      text: "Capture decision points and why options were chosen",
      color: "bg-info",
    },
    {
      text: "Note information that was available vs. not available at each point",
      color: "bg-warning-offset",
    },
    {
      text: "Include non-events (alerts that did not fire, people not paged)",
      color: "bg-success",
    },
  ]}
/>
...
<Table
  ...
  fullWidth={false}
  content={{
    figure: "Translating blame language to learning language.",
...
<Diagram
  src={multipleContributingChainDiagram}
  title="Multiple contributing factors, each with their own chain of causation"
  description="Flowchart showing an incident branching into five contributing factors, each followed by its own explanatory why-chain. Incident points to No config validation, No canary deployment, Alert threshold too high, Runbook outdated, and On-call fatigued. Each factor then points to a specific deeper condition such as Validation not implemented, Perceived as slowing deploys, Alert fatigue led to raised threshold, No runbook review process, or Short-staffed and heavy incident load. The diagram illustrates that failures come from multiple interacting contributors rather than a single root cause."
/>
...
<List
  ...
  items={[
    ...
    {
      lead: "Why did the engineer make a mistake?",
      text: "Because they were careless.",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: "Why did the system go down?",
      text: "Because a config change disabled authentication.",
    },
    {
      lead: "Why did the config change disable authentication?",
      text: "Because the config schema changed and old values became invalid.",
    },
    {
      lead: "Why did old values become invalid?",
      text: "Because the migration script didn't update existing configs.",
    },
    {
      lead: "Why didn't the migration update existing configs?",
      text: "Because no one knew configs existed in that format.",
    },
    {
      lead: "Why didn't anyone know?",
      text: "Because documentation was outdated and there was no config inventory.",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: "Linear assumption:",
      text: "Five Whys assumes a single causal chain, but most incidents have multiple interacting causes. You may need to run multiple chains in parallel.",
    },
    {
      lead: "Arbitrary stopping point:",
      text: "\"Five\" is arbitrary. Sometimes you need three whys, sometimes eight. Stop when you reach something you can change.",
    },
    {
      lead: "Leading questions:",
      text: "The phrasing of each \"why\" shapes the answer. \"Why didn't they test?\" leads to blame. \"What prevented testing?\" leads to systems.",
    },
    {
      lead: "Knowledge limits:",
      text: "You can only ask \"why\" about things you know happened. Unknown factors don't get investigated.",
    },
  ]}
/>
...
<Diagram
  src={stampModelDiagram}
  title="STAMP model showing the control hierarchy and feedback loops that govern system behavior"
  description="Flowchart with two grouped sections. The Control Structure group shows Company Leadership setting priorities for Engineering Management, which allocates resources to the Platform Team, which creates tools for the Deploy Pipeline, which enables Engineer Actions. The Feedback Loops group shows Engineer Actions sending incident reports to the Platform Team, the Platform Team sending metrics to Engineering Management, and Engineering Management sending performance data back to Company Leadership. The diagram emphasizes how safety and failure are shaped by organizational control layers and by whether feedback reaches the right level."
/>
...
<Table
  variant="numbered-review-table"
  content={{
    figure: "CAST analysis questions across control hierarchy levels.",
...
<Table
  ...
  content={{
    figure: "Characteristics of effective action items.",
    thead: { th: ["Characteristic", "What It Means", "Example"] },
    tbody: {
      tr: [
        {
          th: "Specific",
          td: ["Clear what needs to be built or changed", "\"Add validation for auth config changes\""],
        },
        {
          th: "Measurable",
          td: ["You can tell when it's done", "\"Deploy canary to 1% before full rollout\""],
        },
        {
          th: "Assignable",
          td: ["Single owner, clear responsibility", "\"Platform team owns, Sarah implements\""],
        },
        {
          th: "Realistic",
          td: ["Achievable in stated timeframe", "\"Can be completed in one sprint\""],
        },
        {
          th: "Systemic",
          td: ["Prevents class of incidents, not just this one", "\"Blocks all invalid configs, not just this format\""],
        },
      ],
    },
  }}
...
<List
  ...
  items={[
    {
      lead: "Good examples:",
      text: '"Add pre-deploy hook that validates config schema."<br /><br />"Implement 1% canary with automatic rollback on error spike."<br /><br />"Add config change review requirement to deploy pipeline."',
    },
    {
      lead: "Bad examples:",
      text: '"Be more careful with config changes."<br /><br />"Engineer X needs training."<br /><br />"Review all configs."<br /><br />"Improve monitoring."',
    },
  ]}
/>
...
<Table
  variant="numbered-review-table"
  content={{
    figure: "Prioritization matrix for remediation actions.",
...
<Diagram
  src={remediationPrioritizationDiagram}
  title="Remediation prioritization quadrants"
  description="Flowchart grouping remediation examples by priority. The P0 Do Now group contains Config validation. The P1 Plan group contains Canary deploys. The P2 Quick Wins group contains Update runbook and Better errors. The P3 and P4 Defer group contains Redesign config. The diagram summarizes how actions are sorted by a combination of impact and effort, with immediate low-effort high-impact work separated from planned, quick-win, and deferred work."
/>
  ...
  items={[
    {
      ...
      text: "This section is the most-read section. Write it last, after you understand the full picture, but put it first. Two to three sentences covering what broke, what the impact was, and the most important learning. Busy stakeholders may read only this.",
    },
    {
      lead: "What Went Well",
      text: "This section is often skipped but shouldn't be. It's easy to focus entirely on what failed, but understanding what _worked_ is equally important. Maybe your monitoring detected the issue quickly. Maybe your on-call response was fast. Maybe a safeguard limited the blast radius.",
    },
    {
      lead: "Lessons Learned",
      text: "This section should transcend the specific incident. \"Don't deploy config changes on Friday\" is incident-specific. \"Config changes need the same safety checks as code changes\" is a lesson that applies broadly.",
    },
  ]}
/>
...
<Table
  ...
  content={{
    figure: "Different audiences need different sections of the postmortem.",
...
<List
  ...
  items={[
    {
      lead: "For executives:",
      text: "Lead with business impact in concrete terms — users affected, revenue lost, SLA implications. Avoid jargon. The executive summary should be understandable by someone who doesn't know your tech stack.",
      color: "border-secondary",
    },
    {
      lead: "For on-call engineers:",
      text: "The timeline is their reference. Include what symptoms were visible, what commands were run, what worked and what didn't. When they're investigating a similar incident at 3 AM, they'll search for symptoms and want to find your timeline.",
      color: "border-info",
    },
    {
      lead: "For future investigators:",
      text: "Nothing is too detailed for the appendix. Raw log snippets, dashboard screenshots, Slack thread links, config diffs — anything that helped you understand the incident might help them understand a related one.",
      color: "border-accent-offset",
    },
    {
      lead: "For other teams:",
      text: "The lessons learned section is their entry point. Write it as if explaining to a competent engineer who wasn't involved. What would you want them to take away and apply to their own systems?",
  ...
  items={[
    {
      ...
      lead: "Tells you whether postmortems are happening.",
      text: "A low postmortem rate means incidents are slipping through — either under-reported or not analyzed. Long time-to-postmortem means context is being lost (memory fades fast). Low action completion rate means you're doing analysis but not improving anything.",
    },
    {
      title: "Outcome metrics:",
      lead: "Tells you whether postmortems are working.",
      text: "Recurrence rate is the gold standard: are the same types of incidents happening again after you've supposedly fixed them? If your recurrence rate is high, either your contributing factor analysis is missing the real causes, or your remediation isn't effective. MTTR trend shows whether your incident response is improving — better runbooks, better tooling, and better pattern recognition should drive this down over time.",
    },
    {
      title: "Culture metrics:",
      lead: "Tells you whether the environment supports learning.",
      text: "Near-miss reports are particularly revealing. In a psychologically safe environment, people report close calls because they want to prevent future incidents. In a blame-heavy environment, people stay quiet because reporting brings scrutiny. An increasing trend in near-miss reports is one of the best indicators that your blameless culture is real, not aspirational.",
    },
  ]}
/>
...
<Table
  variant="numbered-review-table"
  content={{
    figure: "What different metric categories reveal about postmortem program health.",
...
<Download
  resource="blameless-postmortem-incident-analysis-systemic-causes"
  title="Download the Blameless Postmortem Guide"
  description="Get the complete incident analysis playbook for systemic investigations, facilitator workflows, and recurrence-prevention action tracking."
  listItems={[
    {
      text: "Systemic cause analysis templates",
    },
    {
      text: "Facilitator interview language guide",
    },
    {
      text: "Postmortem action tracking framework",
    },
    {
      text: "Psychological safety implementation playbook",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: "Human error is where investigation begins, not where it ends.",
      text: "Every incident involves human actions, but the interesting question is always: what made that action likely, possible, and undetected?",
    },
    {
      lead: "Blame produces hiding; systems thinking produces learning.",
      text: "When people fear punishment, they stop reporting. When they feel safe, they share near-misses that prevent future incidents.",
    },
    {
      lead: "Incidents have contributing factors, not root causes.",
      text: "Complex failures arise from multiple interacting conditions. Fix any one of them and the specific incident might not have happened — but you won't know which ones matter most until you identify them all.",
    },
    {
      lead: "Effective remediation requires specific, systemic action items tracked to completion.",
      text: "Vague actions don't get done. Person-focused actions don't prevent recurrence. Only concrete system improvements, verified and measured, actually reduce risk.",
    },
  ]}
/>
