...
import moduleInterfaceDiagram from "./diagrams/module-interface-separates-what-consumers-depend-on-from-implementation-details.png"
...
<List
  ...
  items={[
    {
      text: 'Remove or rename an input variable',
    },
    {
      text: "Change an input variable's type",
    },
    {
      text: 'Remove an output',
    },
    {
      text: "Change an output's type or structure",
    },
    {
      text: 'Remove a resource (causes state issues for consumers)',
    },
    {
      text: 'Bump a provider minimum version that has breaking changes',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      text: 'Add a new input variable with a default value',
    },
    {
      text: 'Add a new output',
    },
    {
      text: 'Add a new resource (assuming no side effects)',
    },
    {
      text: 'Deprecate (but not remove) an input or output',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      text: "Fix a bug without changing behavior consumers depend on",
    },
    {
      text: 'Update documentation',
    },
    {
      text: "Internal refactoring that doesn't affect state",
    },
    {
      text: 'Update provider constraints within compatible ranges',
    },
  ]}
/>
