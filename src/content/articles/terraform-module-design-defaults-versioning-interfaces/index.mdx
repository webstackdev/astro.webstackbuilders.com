...
<Highlighter>The difference between modules that teams love and modules that teams fork-and-forget comes down to interface design.</Highlighter> Specifically, how you handle defaults and what you consider a breaking change. Get these right, and your module becomes the obvious choice. Get them wrong, and you'll spend more time fielding support questions than writing infrastructure.
...
<Table
  ...
  content={{
    thead: {
      th: ['Change Type', 'Breaking?', 'Migration Action'],
    },
    tbody: {
      tr: [
        {
        ...
        },
        {
          ...
          td: ['Yes', 'Deprecate in prior version; document in changelog'],
        },
        {
          th: 'Change input type',
          td: ['Yes', 'Document migration steps in changelog'],
        },
        {
          th: 'Add new output',
          td: ['No', 'Ship it'],
        ...
        {
          th: 'Remove output',
          td: ['Yes', 'Deprecate in prior version; document replacement'],
        },
        {
          th: 'Rename resource',
          td: ['Yes', 'Add `moved` block to preserve state'],
        },
      ],
    },
    figure: 'Common module changes and whether they break consumers.',
  }}
/>
...
<List
  ...
  items={[
    {
      lead: 'Major version (2.0.0 → 3.0.0):',
      text: 'Breaking changes. Consumers should read the changelog before upgrading.',
    },
    {
      lead: 'Minor version (2.1.0 → 2.2.0):',
      text: 'New features, backward compatible. Safe to upgrade.',
    },
    {
      lead: 'Patch version (2.1.1 → 2.1.2):',
      text: 'Bug fixes only. Always safe.',
    },
  ]}
/>
