...
<List
  ...
  items={[
    {
      text: 'Map each changed file to its containing package',
    },
    {
      text: 'Build a reversed dependency graph (dependents instead of dependencies)',
    },
    {
      text: 'Walk the graph from each changed package, collecting everything reachable',
    },
    {
      text: 'Everything not in the affected set can be skipped',
    },
  ]}
/>
