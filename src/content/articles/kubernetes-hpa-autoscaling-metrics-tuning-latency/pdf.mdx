...
import customMetricsDiagram from "./diagrams/custom-metrics-flow-from-application-to-hpa.png"
import hpaDebuggingDiagram from "./diagrams/hpa-debugging-decision-tree.png"
import hpaPolicyDiagram from "./diagrams/hpa-policy-selection-flow.png"
import hpaScalingDiagram from "./diagrams/hpa-scaling-decision-flow.png"
...
<List
  ...
  items={[
    {
      lead: "CPU metric",
      text: "60% utilization, target 50% → $$5 \\times (60/50) = 6$$ replicas",
    },
    {
      lead: "RPS metric",
      text: "120 RPS/pod, target 100 → $$5 \\times (120/100) = 6$$ replicas",
    },
    {
      lead: "Latency metric",
      text: "400ms P99, target 500ms → $$5 \\times (400/500) = 4$$ replicas",
    },
  ]}
/>
