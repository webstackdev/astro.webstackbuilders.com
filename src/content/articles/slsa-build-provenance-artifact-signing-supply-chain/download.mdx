...
<List
  ...
  items={[
    { text: "Supply chain attack vectors: source compromise, build tampering, and artifact substitution" },
    { text: "SLSA levels: what each level requires and when to target which level" },
    { text: "Build provenance: generating and verifying attestations about artifact origin" },
    { text: "Artifact signing: cryptographic verification with Cosign and keyless signing" },
    { text: "Deployment verification: enforcing signed artifacts in production" },
    { text: "Practical implementation: free tools and integration with CI/CD platforms" }
  ]}
/>
