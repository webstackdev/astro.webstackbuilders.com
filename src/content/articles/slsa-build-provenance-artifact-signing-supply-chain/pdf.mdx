...
import sbomDiagram from "./diagrams/sbom-and-provenance-relationship.png"
import supplyChainDiagram from "./diagrams/supply-chain-attack-points.png"
...
<List
  ...
  items={[
    {
      lead: 'Symptoms:',
      text: 'cosign verify returns an error, admission webhook denies pods, deployments blocked.',
    },
    {
      lead: 'Cause:',
    ...
    {
      lead: 'Diagnosis:',
      text: 'Check what identity actually signed the image:',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: 'Branch vs tag reference:',
      text: 'You signed from refs/heads/main but the policy expects refs/tags/v*',
    },
    {
      lead: 'Workflow path changed:',
      text: 'You renamed or moved your workflow file',
    },
    {
      lead: 'Wrong OIDC issuer:',
...
<List
  ...
  items={[
    ...
    {
      lead: 'Fix:',
      text: 'Add the permission block to your workflow:',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: 'Symptoms:',
      text: 'slsa-verifier fails, attestation download returns empty.',
    },
    {
      lead: 'Cause:',
...
<List
  ...
  items={[
    ...
    {
      text: "Verify you're using a pinned version of slsa-github-generator (not @main)",
    },
    {
