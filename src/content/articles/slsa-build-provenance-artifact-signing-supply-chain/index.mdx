---
title: "Keyless Container Signing in 15 Minutes"
...
Here's the good news: you can implement practical supply chain protection _today_ without managing keys, standing up infrastructure, or paying for expensive tooling. The barrier has dropped dramatically in the past few years, and the core protection — cryptographic signing with identity-based verification — is now free. <Highlighter>If you're already comfortable with GitHub Actions, you can add signing to an existing pipeline in about 15 minutes.</Highlighter> If you're newer to these tools, budget an hour to understand the OIDC flow and test your configuration.
...
<List
  ...
  items={[
    {
      lead: 'SLSA provenance generators',
      text: 'Create cryptographically-signed attestations linking artifacts to specific commits and build configurations. The [slsa-framework](https://github.com/slsa-framework/slsa-github-generator) organization provides official generators for GitHub Actions.',
    },
    {
      lead: 'SBOM integration',
      text: 'Adds a Software Bill of Materials to your images, listing every dependency. When a new CVE drops, you can answer "are we affected?" in minutes.',
    },
    {
      lead: 'Kubernetes admission control',
      text: 'With the Sigstore Policy Controller, makes verification automatic and mandatory at the cluster level-no deployment workflow changes needed.',
    },
    {
      lead: 'Level 3 hardening',
      text: 'Introduces two-person review requirements and isolated build environments for your most security-critical components.',
    },
  ]}
/>
