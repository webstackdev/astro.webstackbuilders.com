...
<List
  ...
  items={[
    ...
    {
      lead: 'API key',
      text: 'is the standard for B2B APIs. Per-customer limits, usage tracking, revocation—all straightforward. The risk is key sharing: customers distributing their key to multiple applications, or keys getting stolen and abused.',
    },
    {
      lead: 'User ID',
    ...
    {
      lead: 'Composite keys',
      text: '(user + action, IP + endpoint) give you fine-grained control at the cost of complexity and key explosion. Useful when different operations need different limits.',
    },
  ]}
/>
