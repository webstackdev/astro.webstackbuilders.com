...
import sameBurstDiagram from "./diagrams/same-burst-traffic-different-outcomes.png"
import slidingWindowDiagram from "./diagrams/sliding-window-weighted-calculation-prevents-boundary-exploitation.png"
...
<Table
  ...
  content={{
    thead: {
      th: ['Layer', 'Tools', 'Latency', 'Granularity', 'Best For'],
    },
    tbody: {
      tr: [
        {
          th: 'Edge/CDN',
          td: ['Cloudflare, CloudFront, Fastly', 'Lowest', 'IP, geography', 'DDoS, bot protection'],
        },
        {
          th: 'API Gateway',
          td: ['AWS API Gateway, Kong, nginx', 'Low', 'API key, route', 'API quotas, tiered plans'],
        },
        {
          th: 'Service Mesh',
          td: ['Istio, Envoy, Linkerd', 'Low', 'Service identity', 'Service-to-service limits'],
        },
        {
          th: 'Application',
          td: ['Custom middleware', 'Higher', 'User, action, context', 'Fine-grained business logic'],
        },
      ],
    },
...
<List
  ...
  items={[
    {
      text: 'Token bucket (10 tokens, 1/s refill): All 10 served instantly, ~0ms latency each',
    },
    {
      text: 'Leaky bucket (10 queue, 1/s leak): Queued, served over 10 seconds—0ms, 1s, 2s, ... 9s latency',
    },
  ]}
/>
  ...
  content={{
    ...
    tbody: {
      tr: [
        {
          th: '`RateLimit-Limit`',
          td: ['Maximum requests allowed', '`100`'],
        },
        {
          th: '`RateLimit-Remaining`',
          td: ['Requests left in window', '`47`'],
        },
        {
          th: '`RateLimit-Reset`',
          td: ['Seconds until reset', '`30`'],
        },
      ],
    },
