...
<List
  ...
  items={[
    ...
    {
      lead: 'Flat hierarchy.',
      text: 'All spans at the same level, no nesting. You can\'t tell which operations are contained within others, or whether operations ran sequentially or in parallel. The fix is ensuring child spans inherit from their parents using `startActiveSpan`.',
    },
    {
      lead: 'Missing gaps.',
    ...
    {
      lead: 'Cryptic names.',
      text: 'Span names like "span," "operation," "handler," or "process" that don\'t explain what\'s happening. Auto-instrumentation often produces these. The fix is customizing span names to follow the pattern "operation resource" (`HTTP GET /api/orders`, `db.query orders`).',
    },
    {
