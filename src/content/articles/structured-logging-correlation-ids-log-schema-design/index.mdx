  ...
  content={{
    ...
    tbody: {
      tr: [
        {
          th: 'Trace ID',
          td: ['Entire request tree', 'Connect all services in a request', '`4bf92f3577b34da6a...`'],
        },
        {
          th: 'Span ID',
          td: ['Single service hop', 'Distinguish parent/child operations', '`00f067aa0ba902b7`'],
        },
        {
          th: 'Request ID',
          td: ['Single HTTP request', 'Correlate with load balancer logs', '`req_abc123`'],
        },
        {
          th: 'Transaction ID',
          td: ['Business operation', 'Group related requests (e.g., checkout flow)', '`order-12345`'],
        },
      ],
    },
