...
import correlationIdDiagram from "./diagrams/correlation-ID-flow-across-services.png"
import logPipelineDiagram from "./diagrams/log-pipeline-architecture.png"
import schemaQueryDiagram from "./diagrams/schema-query-coverage-comparison.png"
