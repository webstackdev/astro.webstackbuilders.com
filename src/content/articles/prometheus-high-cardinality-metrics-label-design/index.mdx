---
title: "The Prometheus Label That Ate Your Storage Budget"
...
>
> — A senior engineer during sprint planning
...
<Highlighter>The fix took five minutes: remove <span class="font-mono">user_id</span> from labels, add it to traces instead.</Highlighter> The lesson took three days of firefighting to learn.
...
<Table
  ...
  classes={{
    tbody:
      '!text-content [&_td:nth-child(3)]:text-center [&_td:nth-child(4)]:text-center [&_td:nth-child(5)]:text-center',
  }}
  content={{
    thead: {
    ...
    tbody: {
      tr: [
        ...
        {
          th: 'Dangerous',
          td: ['+ user_id', '× 100,000', '480,000,000', '~4.8 TB[^1]'],
        },
      ],
    },
