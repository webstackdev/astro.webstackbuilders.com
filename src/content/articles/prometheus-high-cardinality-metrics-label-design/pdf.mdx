...
import singleUnboundedLabelDiagram from "./diagrams/a-single-unbounded-label-transforms-manageable-metrics-into-infrastructure-killing-cardinality.png"
...
<Table
  ...
  content={{
    ...
    tbody: {
      tr: [
        {
          th: '<span class="font-mono">http_method`',
          td: [
            '<span class="font-mono">GET, POST, PUT, DELETE, PATCH',
            '~7',
            'Fixed set defined by HTTP spec',
          ],
        },
        {
          th: '<span class="font-mono">environment`',
          td: [
        ...
        {
          th: '<span class="font-mono">status_class`',
