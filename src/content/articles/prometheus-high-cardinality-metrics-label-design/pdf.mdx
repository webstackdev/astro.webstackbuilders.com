...
flowchart LR
  ...
  subgraph withoutUserId[Without user_id]
    S1[200 series<br/>4 × 10 × 5]
    MEM1[~2 MB RAM]
  end

  subgraph withUserId[With user_id]
