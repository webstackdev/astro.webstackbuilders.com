...
<Highlighter>Here's what makes this worse: a catalog with 80% accurate data is more dangerous than no catalog at all. It gives you false confidence.</Highlighter> You page the listed owner at 3 AM, confident you've got the right team, and waste twenty minutes before discovering they handed off the service six months ago. Every minute spent paging the wrong team is a minute your users are affected.
...
<Table
  ...
  content={{
    ...
    thead: {
      th: ['Role', 'Responsibility', 'When contacted'],
    },
    tbody: {
      tr: [
        {
          th: 'Primary owner',
          td: ['Development, roadmap, architecture', 'Default for anything not covered by a specific role'],
        },
        {
          th: 'Oncall',
  ...
  content={{
    ...
    tbody: {
      tr: [
        ...
        {
          th: 'Freshness (30-day)',
          td: ['Updated within last 30 days / Cataloged', '> 70%'],
        },
      ],
    },
