...
tags: ["platform-engineering","backstage-idp","kubernetes","prometheus","grafana"]
featured: true
---
...
<Table
  ...
  fullWidth={false}
  content={{
    figure: 'Catalog trust decay over time.',
    thead: {
      th: ['Time', 'Coverage', 'Accuracy', 'Team trust'],
    },
    tbody: {
      tr: [
        {
...
<Table
  ...
  content={{
    figure: 'Common catalog failure modes and their root causes.',
    thead: {
      th: ['Failure Mode', 'Symptom', 'Root Cause'],
    },
    tbody: {
      tr: [
        {
          th: 'Stale ownership',
          td: ['Paging wrong team during incidents', 'No ownership update workflow'],
        },
        {
          th: 'Missing services',
          td: ['Services in prod not in catalog', 'Catalog not in deployment path'],
        },
        {
          th: 'Wrong dependencies',
          td: ['Dependency graph incomplete', 'Manual entry, no validation'],
        },
        {
          th: 'Outdated metadata',
          td: ["Descriptions don't match reality", 'No freshness enforcement'],
        },
        {
          th: 'Orphaned entries',
          td: ['Deleted services still listed', 'No lifecycle management'],
        },
      ],
    },
  }}
...
<Table
  ...
  content={{
    figure: 'Accuracy requirements by use case.',
    thead: {
      th: ['Use Case', 'Accuracy Needed', 'Required Fields', 'Why It Matters'],
    },
    tbody: {
      tr: [
        {
          th: 'Incident response',
          td: [
            '98%+',
            'owner, oncall, runbook, dependencies',
            'Wrong owner during incident extends MTTR by 15-30 minutes',
          ],
        },
        {
          th: 'Security scanning',
          td: ['95%', 'repository, runtime, data classification', 'Missing services mean unscanned attack surface'],
        },
        {
          th: 'Cost attribution',
          td: ['90%', 'owner, cost center, environment', '10% error in cloud bills is acceptable for most orgs'],
        },
        {
          th: 'Dependency analysis',
          td: ['85%', 'dependencies, consumers, API endpoints', 'Used for planning, not emergencies'],
        },
        {
          th: 'Developer onboarding',
          td: ['80%', 'description, documentation, owner', "Stale docs annoy but don't cause outages"],
        },
      ],
    },
  }}
...
<Table
  ...
  content={{
    figure: 'Catalog vs CMDB vs service mesh.',
    thead: {
      th: ['Aspect', 'Service Catalog', 'CMDB', 'Service Mesh'],
    },
    tbody: {
      tr: [
        {
          th: 'Primary audience',
          td: ['Developers, SREs', 'IT Operations', 'Runtime systems'],
        },
        {
          th: 'Data source',
          td: ['Declarative + discovered', 'Manual entry', 'Runtime observation'],
        },
        {
          th: 'Update frequency',
          td: ['On deploy/change', 'Periodic audits', 'Real-time'],
        },
        {
          th: 'Ownership tracking',
          td: ['Primary purpose', 'Often missing', 'Not applicable'],
        },
        {
          th: 'Dependency data',
          td: ['Declared + inferred', 'Declared only', 'Observed only'],
        },
        {
          th: 'Accuracy model',
          td: ['Continuous validation', 'Point-in-time', 'Always current (for running services)'],
        },
      ],
    },
  }}
...
<Table
  variant="numbered-review-table"
  content={{
    figure: 'Core catalog entities and relationships.',
    thead: {
      th: ['Entity', 'Key relationships'],
    },
    tbody: {
      tr: [
        {
          th: 'Service',
          td: ['Owned by Team, depends on Service, sourced from Repository, belongs to Domain'],
        },
        {
          th: 'Team',
          td: ['Owns Service, has Person members'],
        },
        {
          th: 'Repository',
          td: ['Source of Service definition'],
        },
        {
          th: 'Domain',
          td: ['Business grouping for Service ownership and reporting'],
        },
      ],
    },
  }}
...
<Table
  variant="numbered-review-table"
  content={{
    figure: 'Service entity field categories.',
    thead: {
      th: ['Category', 'Fields', 'Purpose'],
    },
    tbody: {
      tr: [
        {
          th: 'Identity',
          td: ['id, name, slug', 'Establish uniqueness'],
        },
        {
          th: 'Classification',
          td: ['tier, lifecycle, domain, type', 'Determine automation behavior'],
        },
        {
          th: 'Ownership',
          td: ['owner, contacts', 'Enable incident routing'],
        },
        {
          th: 'Technical',
          td: ['repository, language, runtime', 'Support security scanning and dependency analysis'],
        },
        {
          th: 'Operational',
          td: ['runbook, documentation, SLO reference', 'Support incident response'],
        },
      ],
    },
  }}
...
<List
  ...
  items={[
    {
      lead: '<span class="font-mono">owner</span>:',
      text: 'Which team is responsible',
    },
    {
      lead: '<span class="font-mono">tier</span>:',
      text: 'How critical is this service (determines incident priority)',
    },
    {
      lead: '<span class="font-mono">repository</span>:',
      text: "Where's the code",
    },
    {
      lead: '<span class="font-mono">oncall_schedule</span>:',
      text: 'Who gets paged (can be on owner team)',
    },
    {
      lead: '<span class="font-mono">lifecycle</span>:',
...
<Table
  variant="numbered-review-table"
  content={{
    figure: 'Ownership roles and their triggers.',
    thead: {
      th: ['Role', 'Responsibility', "When they're contacted"],
    },
    tbody: {
      tr: [
        {
          th: 'Primary owner',
          td: ['Service development, roadmap, architecture decisions', 'Default for anything not covered by a specific role'],
        },
        {
          th: 'Oncall',
          td: ['Incident response, production issues', 'Automated alerts, P1/P2 incidents'],
        },
        {
          th: 'Security contact',
          td: ['Vulnerability remediation, security reviews', 'CVE notifications, penetration test findings'],
        },
        {
          th: 'Change approver',
          td: ['Production deployment approval', 'Release management workflows'],
        },
        {
          th: 'Cost owner',
          td: ['Budget decisions, optimization', 'FinOps alerts, capacity planning'],
        },
      ],
    },
  }}
...
<List
  ...
  classes={{
    wrapper: "sm:ml-6 sm:mr-12 mb-2",
  }}
  items={[
    {
      lead: 'The current owner explicitly releases responsibility',
    },
    {
      lead: 'The new owner explicitly accepts it',
    },
    {
      lead: 'Critical knowledge transfers before the handoff completes',
    },
    {
      lead: 'Both teams are on the escalation path during transition',
    },
  ]}
/>
...
<Table
  ...
  content={{
    figure: 'Ownership transfer phases.',
    thead: {
      th: ['Transfer phase', 'Duration', "Who's on-call", 'What happens'],
    },
    tbody: {
      tr: [
        {
          th: 'Pending approval',
          td: ['Until both approve', 'Old team only', 'Transfer request sits in queue'],
        },
        {
          th: 'Knowledge transfer',
          td: ['1 week typical', 'Old team only', 'Runbook review, access provisioning, documentation walkthrough'],
        },
        {
          th: 'Transition period',
          td: ['2 weeks default', 'Both teams', 'New team primary, old team escalation'],
        },
        {
          th: 'Complete',
          td: ['---', 'New team only', 'Old team removed, catalog updated'],
        },
      ],
    },
  }}
...
<Table
  variant="numbered-review-table"
  content={{
    figure: 'Knowledge transfer checklist.',
    thead: {
      th: ['Item', 'Details', 'Automatable?'],
    },
    tbody: {
      tr: [
        {
          th: 'Runbook review',
          td: ['Walk through incident procedures', 'No'],
        },
        {
          th: 'Access provisioning',
          td: ['AWS, Kubernetes, CI/CD, monitoring', 'Yes (via IDP)'],
        },
        {
          th: 'Oncall schedule',
          td: ['Update PagerDuty/Opsgenie rotation', 'Yes (via API)'],
        },
        {
          th: 'Documentation review',
          td: ['Answer questions, update gaps', 'No'],
        },
        {
          th: 'Stakeholder notification',
          td: ['Dependent service owners, PMs', 'Yes (via catalog)'],
        },
        {
          th: 'Cost center update',
          td: ['FinOps allocation change', 'Yes (via API)'],
        },
      ],
    },
  }}
...
<List
  variant="side-by-side-list"
  classes={{
    wrapper: "sm:mr-12 mb-12",
  }}
  items={[
    {
      lead: 'Dissolved teams:',
      text: 'The team ID in the catalog no longer exists in your identity provider',
    },
    {
      lead: 'Empty teams:',
      text: 'The team exists but has zero members',
    },
    {
      lead: 'Inactive teams:',
      text: "The team hasn't deployed, committed, or responded to incidents in 90+ days",
    },
    {
      lead: 'Missing oncall:',
      text: 'tier-1 / tier-2 services without a valid oncall schedule',
    },
  ]}
/>
...
<Table
  variant="numbered-review-table"
  content={{
    figure: 'Dependency types by criticality.',
    thead: {
      th: ['Dependency type', 'Description', 'Example'],
    },
    tbody: {
      tr: [
        {
          th: 'Runtime critical',
          td: ['Service fails if dependency is unavailable', 'Database, auth service'],
        },
        {
          th: 'Runtime degraded',
          td: ['Service works with reduced functionality', 'Recommendation engine, analytics'],
        },
        {
          th: 'Startup only',
          td: ['Needed at boot but not ongoing', 'Config service, secrets manager'],
        },
        {
          th: 'Async/background',
          td: ['Used for non-blocking operations', 'Message queue, batch processor'],
        },
        {
          th: 'Development only',
          td: ['Not used in production', 'Mock services, test fixtures'],
        },
      ],
    },
  }}
...
<Table
  ...
  content={{
    figure: 'Dependency discovery sources and their tradeoffs.',
    thead: {
      th: ['Source', 'What it catches', 'Confidence', 'Limitations'],
    },
    tbody: {
      tr: [
        {
          th: 'Catalog declarations',
          td: ['Intentional dependencies', 'High (if maintained)', 'Goes stale without enforcement'],
        },
        {
          th: 'Service mesh (Istio/Linkerd)',
          td: ['HTTP/gRPC traffic between services', 'High', 'Misses non-mesh traffic'],
        },
        {
          th: 'Distributed tracing[^2]',
          td: ['Cross-service calls in traced requests', 'Medium-high', 'Sampling may miss infrequent calls'],
        },
        {
          th: 'DNS query logs',
          td: ['Service discovery lookups', 'Medium', "Can't distinguish used from resolved"],
        },
        {
          th: 'Database connection logs',
          td: ['Direct database dependencies', 'High', 'Requires database-level logging'],
        },
      ],
    },
  }}
...
<List
  ...
  items={[
    {
      lead: 'Validated:',
      text: 'Declared and observed-this dependency is real and documented',
    },
    {
      lead: 'Declared but not observed:',
      text: 'In the catalog but no recent traffic-possibly stale or only used in specific scenarios',
    },
    {
      lead: 'Undeclared:',
      text: 'Observed in traffic but not in catalog-shadow dependency, needs to be declared',
    },
    {
      lead: 'Unknown:',
      text: "Neither declared nor observed-shouldn't exist in the graph",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: 'What does service X depend on? (direct and transitive)',
    },
    {
      lead: 'What depends on service X? (consumers/reverse dependencies)',
    },
    {
      lead: "What's the blast radius if service X fails?",
    },
    {
      lead: 'Are there circular dependencies?',
    },
    {
      lead: "What's the critical path between service A and service B?",
    },
  ]}
/>
...
<Table
  ...
  content={{
    figure: 'Common dependency graph queries.',
    thead: {
      th: ['Query', 'Use case', 'Output'],
    },
    tbody: {
      tr: [
        {
          th: '<span class="font-mono">getDependencies(serviceId, depth=2)</span>',
          td: ['Pre-deployment impact check', 'Tree of downstream services'],
        },
        {
          th: '<span class="font-mono">getConsumers(serviceId)</span>',
          td: ['Maintenance notification list', 'List of teams to notify'],
        },
        {
          th: '<span class="font-mono">getBlastRadius(serviceId)</span>',
          td: ['Incident severity assessment', 'Affected services by tier'],
        },
        {
          th: '<span class="font-mono">detectCycles()</span>',
          td: ['Architecture health check', 'List of circular dependency chains'],
        },
        {
          th: '<span class="font-mono">findCriticalPath(from, to)</span>',
...
<List
  ...
  items={[
    {
      lead: 'Audit trail:',
      text: 'Git history shows who changed what and when',
    },
    {
      lead: 'Review process:',
      text: 'Catalog changes get the same scrutiny as code changes',
    },
    {
      lead: 'Atomic updates:',
      text: 'Code and catalog changes ship together',
    },
    {
      lead: 'Developer ownership:',
      text: 'Teams maintain their own entries rather than relying on a central team',
    },
  ]}
/>
...
<Table
  variant="numbered-review-table"
  content={{
    figure: 'Validation enforcement by tier.',
    thead: {
      th: ['Service tier', 'Missing owner', 'Missing runbook', 'Missing dependencies'],
    },
    tbody: {
      tr: [
        {
          th: '<span class="font-mono">tier-1</span>',
          td: ['Block deploy', 'Block deploy', 'Block deploy'],
        },
        {
          th: '<span class="font-mono">tier-2</span>',
          td: ['Block deploy', 'Block deploy', 'Warn'],
        },
        {
          th: '<span class="font-mono">tier-3</span>',
          td: ['Block deploy', 'Warn', 'Warn'],
        },
        {
          th: '<span class="font-mono">tier-4</span>',
  ...
  items={[
    {
      ...
      text: 'Every 6 months, require teams to confirm they still own their services',
    },
    {
      lead: 'Dependency review:',
      text: 'Every 90 days for tier-1/2 services, flag declared dependencies not observed in traffic',
    },
    {
      lead: 'Runbook freshness:',
      text: 'Every 90 days, remind owners to review runbooks for accuracy',
    },
  ]}
/>
...
<Table
  ...
  content={{
    figure: 'Drift detection types and data sources.',
    thead: {
      th: ['Drift type', 'What it catches', 'Data sources'],
    },
    tbody: {
      tr: [
        {
          th: 'Missing service',
          td: ['Running in prod, not in catalog', 'Kubernetes API, catalog API'],
        },
        {
          th: 'Invalid owner',
          td: ["Team ID doesn't exist", 'Identity provider, catalog API'],
        },
        {
          th: 'Invalid oncall',
          td: ['Schedule ID not found', 'PagerDuty/Opsgenie API, catalog API'],
        },
        {
          th: 'Undeclared dependency',
          td: ['Traffic observed, not declared', 'Service mesh, catalog API'],
        },
        {
          th: 'Stale dependency',
          td: ['Declared, no recent traffic', 'Service mesh, catalog API'],
        },
      ],
    },
  }}
...
<Table
  ...
  content={{
    figure: 'Catalog API operation categories.',
    thead: {
      th: ['API category', 'Operations', 'Primary consumers'],
    },
    tbody: {
      tr: [
        {
          th: 'Entity CRUD',
          td: ['Get, list, create, update, delete', 'CI/CD pipelines, automation scripts'],
        },
        {
          th: 'Relationship queries',
          td: ['Dependencies, consumers, ancestry', 'Incident tools, impact analysis'],
        },
        {
          th: 'Search',
          td: ['Full-text, filtered, by owner/tag', 'Developer portals, discovery tools'],
        },
      ],
    },
  }}
...
<Table
  ...
  fullWidth={false}
  content={{
    figure: 'Common catalog integrations.',
    thead: {
      th: ['Integration', 'Sync frequency', 'Primary benefit'],
    },
    tbody: {
      tr: [
        {
          th: 'PagerDuty',
          td: ['Real-time (webhook)', 'Correct incident routing'],
        },
        {
          th: 'Datadog',
          td: ['Daily batch', 'Unified service metadata'],
        },
        {
          th: 'Grafana',
          td: ['On catalog change', 'Auto-generated dashboards'],
        },
        {
          th: 'Terraform',
          td: ['Per deploy', 'Infrastructure tagging'],
        },
        {
          th: 'Slack',
          td: ['Real-time', 'Ownership lookups in chat'],
        },
      ],
    },
  }}
...
<Table
  ...
  fullWidth={false}
  content={{
    figure: 'Core catalog health metrics.',
    thead: {
      th: ['Metric', 'Formula', 'Target'],
    },
    tbody: {
      tr: [
        {
          th: 'Coverage ratio',
          td: ['Cataloged / Total', '> 95%'],
        },
        {
          th: 'Owner completeness',
          td: ['With valid owner / Cataloged', '100%'],
        },
        {
          th: 'Oncall completeness (tier-1)',
          td: ['With oncall / tier-1 services', '100%'],
        },
        {
          th: 'Dependency completeness',
          td: ['With dependencies / Cataloged', '> 80%'],
        },
        {
          th: 'Freshness (30-day)',
          td: ['Updated in 30d / Cataloged', '> 70%'],
        },
      ],
    },
  }}
