...
<Table
  ...
  content={{
    thead: {
      th: ['Use Case', 'Required Fields', 'Accuracy Needed', 'Why It Matters'],
    },
    tbody: {
      tr: [
        {
        ...
        },
        {
          ...
          td: ['repository, runtime, data classification', '95%', 'Missing services mean unscanned attack surface'],
        },
        {
          th: 'Cost attribution',
          td: ['owner, cost center, environment', '90%', '10% error in cloud bills is acceptable for most orgs'],
        },
        {
          th: 'Dependency analysis',
          td: ['dependencies, consumers, API endpoints', '85%', 'Used for planning, not emergencies'],
        },
        {
          th: 'Developer onboarding',
          td: ['description, documentation, owner', '80%', "Stale docs annoy but don't cause outages"],
        },
      ],
    },
...
<List
  ...
  items={[
    {
      text: 'The current owner explicitly releases responsibility',
    },
    {
      text: 'The new owner explicitly accepts it',
    },
    {
      text: 'Critical knowledge transfers before the handoff completes',
    },
    {
      text: 'Both teams are on the escalation path during transition',
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      lead: 'What does service X depend on?',
      text: '(direct and transitive)',
    },
    {
      lead: 'What depends on service X?',
      text: '(consumers/reverse dependencies)',
    },
    {
      text: "What's the blast radius if service X fails?",
    },
    {
      text: 'Are there circular dependencies?',
    },
    {
      text: "What's the critical path between service A and service B?",
    },
  ]}
/>
