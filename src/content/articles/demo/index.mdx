...
#### Blockquotes with internal remark-attribution plugin
...
#### Blockquotes with remark-captions
...
```html
<figure class="my-8 mx-auto max-w-none text-center">
  <blockquote class="border-l-2 border-blue-600 my-8 pl-14 -ml-4 font-serif text-2xl italic">
    <p class="mb-8 leading-relaxed">
      Some blockquote text that will have a caption
    </p>
  </blockquote>
  <figcaption class="text-base italic pt-3">
...
[Link](url) [[color=pink target=_blank .centered]]
```
...
__Blockquote example is moved to the Blockquote section.__
...
| Underline | `__   __` | None | `This is an __underlined__ text` | This is an __underlined__ text |
