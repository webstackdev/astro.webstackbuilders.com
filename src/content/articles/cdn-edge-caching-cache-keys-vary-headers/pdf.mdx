...
import cdnEdgeRequestDiagram from "./diagrams/cdn-edge-request-flow-showing-cache-hit-and-miss-paths.png"
import staleWhileRevalidateDiagram from "./diagrams/stale-while-revalidate-serving-stale-content-while-refreshing-in-background.png"
import tagBasedPurgingDiagram from "./diagrams/tag-based-purging-invalidating-all-related-content.png"
  ...
  content={{
    ...
    tbody: {
      tr: [
        ...
        {
          th: "3. Response",
          td: ["Prices in EUR ✓", "Prices in EUR ✗"],
        },
        {
          th: "4. Outcome",
      ...
      tr: [
        {
          ...
          td: [
            "Add `CF-IPCountry` (or equivalent) to cache key",
        ...
        },
        {
          ...
          td: [
            "Use explicit country param: `/api/products?country=DE`",
      ...
      tr: [
        {
          ...
          td: [
            "High",
            "Low",
            "Sort query parameters; remove tracking params (utm_*, fbclid, gclid); remove empty parameters",
          ],
        },
        {
        ...
        },
        {
          ...
          td: [
            "Medium",
            "Medium",
            "Reduce language variants; limit Accept-Encoding values; avoid User-Agent variations",
          ],
        },
        {
          th: "TTL extension",
          td: [
            "High",
            "Low",
            "Use immutable for versioned assets; extend TTL with stale-while-revalidate; implement proper invalidation",
          ],
        },
      ],
    },
