...
The good news: <Highlighter>two concepts cause the vast majority of CDN cache bugs, and once you understand them, you can cache aggressively without fear.</Highlighter> Those concepts are cache keys and Vary headers.
  ...
  items={[
    {
      ...
      text: 'Your origin returns <span class="font-mono">Cache-Control: public</span> for personalized responses',
    },
    {
      color: "bg-danger-offset",
      text: "You vary on session cookie but session IDs still contaminate the cache key",
    },
    {
      color: "bg-danger-offset",
      text: "You cache without checking for authentication headers",
    },
  ]}
/>
...
<Table
  ...
  content={{
    figure: "Personalized content caching patterns.",
