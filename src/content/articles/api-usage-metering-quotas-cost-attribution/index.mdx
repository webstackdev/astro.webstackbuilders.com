...
<List
  ...
  items={[
    { lead: "Request count", text: "Basic usage tracking, quota enforcement" },
    { lead: "Endpoint/route", text: "Cost per feature, optimization targets" },
    { lead: "Compute time", text: "Processing-intensive API pricing" },
    { lead: "Data transfer", text: "Bandwidth costs, egress pricing" },
    { lead: "Consumer ID", text: "Per-team/customer attribution" },
    { lead: "Response status", text: "Error rate tracking, retry detection" },
  ]}
/>
...
<Table
  ...
  content={{
    ...
    tbody: {
      tr: [
        { th: "Rate limiting", td: ["Per-second/minute", "Protect infrastructure"] },
        { th: "Quota enforcement", td: ["Per-day/month", "Control costs"] },
      ],
    },
  }}
/>
...
<List
  variant="numbered-with-background-list"
  items={[
    { lead: "Week 1", text: "Pick your highest-traffic API. Add request count metering only. Emit events to SQS, write to TimescaleDB. Don't enforce anything yet—just capture data." },
    { lead: "Week 2-3", text: "Deploy a read-only dashboard showing usage by consumer. Sort by request count descending. You'll immediately see patterns: one team making 10x more requests than others, endpoints with unexpected traffic, retry storms from misconfigured clients." },
    { lead: "Week 4", text: "Identify the obvious problems. That team making 5 million requests per day when everyone else makes 50,000? Talk to them. That endpoint showing 2 million requests but only 100 unique consumers? Investigate why." },
  ]}
/>
