...
import argocdDiagram from "./diagrams/argocd-generates-applications-centrally-flux-controllers-pull-independently.png"
import configurationLayeringDiagram from "./diagrams/configuration-layering-from-fleet-wide-to-cluster-specific.png"
import multiClusterDiagram from "./diagrams/multi-cluster-topology-patterns.png"
