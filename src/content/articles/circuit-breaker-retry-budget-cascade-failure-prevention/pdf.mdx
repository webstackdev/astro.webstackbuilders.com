...
import circuitBreakerDiagram from "./diagrams/circuit-breaker-retry-budget-cascade-failure-prevention.png"
...
<List
  ...
  items={[
    {
      text: "Each request can retry up to N times",
    },
    {
      text: "Problem: Under failure, ALL requests retry",
    },
    {
      text: "Result: N+1 times the load",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      text: "Total retries limited to X% of successful requests",
    },
    {
      text: "Example: 10% retry budget",
    },
    {
      text: "If 1000 successful requests, allow 100 retries total",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      text: "Budget depletes quickly",
    },
    {
      text: "Result: System stabilizes instead of amplifying",
    },
  ]}
/>
      ...
      tr: [
        {
          ...
          td: ["Review `failure_threshold` and `minimum_requests`"],
        },
        {
        ...
        {
          th: "Window too short",
          td: ["Increase `window_duration` for bursty traffic patterns"],
        },
      ],
    },
  }}
      ...
      tr: [
        {
          ...
          td: ["Verify `failure_conditions` includes the error types you expect"],
        },
        {
          th: "`minimum_requests` too high",
          td: ["Lower it for low-traffic services"],
        },
        {
          th: "Window too long",
          td: ["Decrease `window_duration` to detect failures faster"],
        },
      ],
    },
  }}
  ...
  content={{
    ...
    tbody: {
      tr: [
        ...
        {
          th: "`success_threshold` too high",
          td: ["Reduce `half_open.success_threshold`"],
        },
      ],
    },
  }}
