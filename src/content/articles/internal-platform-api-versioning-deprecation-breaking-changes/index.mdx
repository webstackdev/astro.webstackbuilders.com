...
This happens constantly with internal APIs. There's a temptation to treat them differently than external ones: "we can just tell people to update," "everyone's in the same building," "we'll coordinate in Slack." <Highlighter>But internal APIs deserve _more_ versioning discipline than external ones, not less.</Highlighter>
...
<List
  ...
  items={[
    {
      lead: "Error code changes",
      text: "(400 → 422): Technically correct, but breaks error handling logic",
    },
    {
      lead: "Default value changes",
      text: "Clients that assumed a specific page size or timeout",
    },
    {
      lead: "Semantic changes",
      text: 'Making <span class="font-mono">count</span> include deleted items when it previously didn\'t - breaking even though the field name stays the same',
    },
  ]}
/>
...
<List
  ...
  items={[
    ...
    {
      lead: "Step 5: Schedule the timeline with milestones.",
      text: "Set dates for feedback deadline, new version release, 90-day warning, 30-day warning, and sunset date. Put them in the team calendar. Configure automated reminders. Don't rely on anyone remembering.",
    },
  ]}
/>
