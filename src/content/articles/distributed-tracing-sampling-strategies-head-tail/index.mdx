...
<List
  ...
  items={[
    {
      text: "How head and tail sampling trade cost, complexity, and outcome capture",
    },
    {
      text: "How to pick a strategy at your traffic level and debug when traces go missing",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      text: "Cost control is straightforward. Sample 10% and your ingest costs drop roughly 90%.",
    },
    {
      text: "The infrastructure is simple. The logic lives in the SDK you already run.",
    },
    {
      text: "Traces show up quickly. There is no buffering or delayed decision.",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      text: "Under 1,000 RPS: do not over-optimize. Use head sampling or even full capture in limited windows.",
    },
    {
      text: "1,000 to 10,000 RPS: head sampling is usually enough, unless you must guarantee error capture.",
    },
    {
      text: "Over 10,000 RPS: head sampling for baseline cost control, tail sampling only if you can run it well.",
    },
  ]}
/>
