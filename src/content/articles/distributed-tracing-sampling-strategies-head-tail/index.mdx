...
tags: ["observability-and-telemetry", "typescrip t", "python", "go", "dotnet", "ruby", "grafana"]
featured: true
---
...
<List
  ...
  items={[
    {
      lead: "How head and tail sampling trade cost, complexity, and outcome capture",
    },
    {
      lead: "How to pick a strategy at your traffic level and debug when traces go missing",
    },
  ]}
/>
...
<List
  ...
  classes={{
    em: 'text-page-inverse',
  }}
  items={[
    {
      lead: "Cost control is straightforward:",
      text: "Sample 10% and your ingest costs drop roughly 90%.",
    },
    {
      lead: "The infrastructure is simple:",
      text: "The logic lives in the SDK you already run.",
    },
    {
      lead: "Traces show up quickly:",
      text: "There is no buffering or delayed decision.",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      icon: "error",
      text: "You can capture every error trace.",
    },
    {
      icon: "waiting",
      text: "You can keep all slow traces tied to an SLO breach.",
    },
    {
      icon: "funnel",
      text: "You can filter by business events and keep only the valuable transactions.",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      title: "Under 1,000 RPS:",
      text: "Do not over-optimize. Use head sampling or even full capture in limited windows.",
    },
    {
      title: "1,000 to 10,000 RPS:",
      text: "Head sampling is usually enough, unless you must guarantee error capture.",
    },
    {
      title: "Over 10,000 RPS:",
      text: "Head sampling for baseline cost control, tail sampling only if you can run it well.",
    },
  ]}
/>
...
<List
  ...
  items={[
    {
      text: "Use head sampling to reduce volume to a manageable fraction.",
    },
    {
      text: "Apply tail sampling to that fraction to keep the truly interesting traces.",
    },
  ]}
/>
...
<List
  ...
  classes={{
    wrapper: "sm:ml-6 sm:mr-12 mb-6",
    li: "min-h-12 flex items-center [&>p]:!text-content [&>p]:!text-base",
  }}
  items={[
    {
      color: "border-secondary",
      text: "Always log trace IDs for every request, sampled or not.",
    },
    {
      color: "border-success",
      text: "Correlate logs, metrics, and traces. Metrics with exemplars can point to traces that were sampled.",
    },
    {
      color: "border-orange-500",
      text: "Use on-demand sampling for reproducible issues so you can force a trace when it matters. A simple header like `X-Force-Trace: true` is often enough.",
    },
  ]}
/>
