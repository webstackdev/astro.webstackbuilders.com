...
<Download
  resource="terraform-state-locking-corruption-recovery-backend"
  title="Terraform State: Failure Modes and Recovery"
  description="State locking, backend configuration, and recovery strategies for when state corruption happens."
  listItems={[
    {
      text: "State recovery incident checklist",
    },
    {
      text: "Backend hardening configuration guide",
    },
    {
      text: "Import and state surgery playbook",
    },
    {
      text: "Quarterly disaster drill script",
    },
  ]}
/>
