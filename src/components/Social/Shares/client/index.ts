...
const PLATFORM_ICONS: Record<string, () => ReturnType<typeof html>> = {
  ...
  linkedin: () => html`<g>
    ...
    <path d="M 2.85826,0 C 1.13393,0 0,1.11519 0,2.59586 0,4.04842 1.09645,5.19172 2.79266,5.19172 h 0.0375 c 1.76181,0 2.85825,-1.15267 2.84888,-2.59586 C 5.64154,1.11519 4.5826,0 2.85827,0 Z"></path>
    <path d="m 18.06794,6.92542 c -2.6802,0 -4.35767,1.46193 -4.66692,2.49278 V 7.06599 H 8.14369 c 0.0656,1.24639 0,14.96603 0,14.96603 h 5.25733 v -8.08747 c 0,-0.45919 -0.0188,-0.90902 0.11245,-1.22764 0.35611,-0.89965 1.13393,-1.83678 2.53026,-1.83678 1.82741,0 2.65209,1.38695 2.65209,3.41116 v 7.74073 H 24 V 13.71027 C 24,9.08083 21.39477,6.92542 18.06794,6.92542 Z"></path>
  </g>`,
  bluesky: () => html`<path d="M12 10.8c-1.087-2.114-4.046-6.053-6.798-7.995C2.566.944 1.561 1.266.902 1.565.139 1.908 0 3.08 0 3.768c0 .69.378 5.65.624 6.479.815 2.736 3.713 3.66 6.383 3.364.136-.02.275-.038.416-.054-2.36.166-4.218 1.041-3.696 2.583.51 1.507 2.817 2.701 5.293 2.699 3.274-.003 5.093-1.7 5.093-1.7s1.819 1.697 5.093 1.7c2.476.002 4.783-1.192 5.294-2.699.521-1.542-1.337-2.417-3.697-2.583.14.016.28.034.415.054 2.67.297 5.568-.628 6.383-3.364.246-.828.624-5.79.624-6.478 0-.69-.139-1.861-.902-2.206-.659-.298-1.664-.62-4.3 1.24C16.046 4.748 13.087 8.687 12 10.8z" />`,
  reddit: () => html`<path d="M12 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0zm5.01 4.744c.688 0 1.25.561 1.25 1.249a1.25 1.25 0 0 1-2.498.056l-2.597-.547-.8 3.747c1.824.07 3.48.632 4.674 1.488.308-.309.73-.491 1.207-.491.968 0 1.754.786 1.754 1.754 0 .716-.435 1.333-1.01 1.614a3.111 3.111 0 0 1 .042.52c0 2.694-3.13 4.87-7.004 4.87-3.874 0-7.004-2.176-7.004-4.87 0-.183.015-.366.043-.534A1.748 1.748 0 0 1 4.028 12c0-.968.786-1.754 1.754-1.754.463 0 .898.196 1.207.49 1.207-.883 2.878-1.43 4.744-1.487l.885-4.182a.342.342 0 0 1 .14-.197.35.35 0 0 1 .238-.042l2.906.617a1.214 1.214 0 0 1 1.108-.701zM9.25 12C8.561 12 8 12.562 8 13.25c0 .687.561 1.248 1.25 1.248.687 0 1.248-.561 1.248-1.249 0-.688-.561-1.249-1.249-1.249zm5.5 0c-.687 0-1.248.561-1.248 1.25 0 .687.561 1.248 1.249 1.248.688 0 1.249-.561 1.249-1.249 0-.687-.562-1.249-1.25-1.249zm-5.466 3.99a.327.327 0 0 0-.231.094.33.33 0 0 0 0 .463c.842.842 2.484.913 2.961.913.477 0 2.105-.056 2.961-.913a.361.361 0 0 0 .029-.463.33.33 0 0 0-.464 0c-.547.533-1.684.73-2.512.73-.828 0-1.979-.196-2.512-.73a.326.326 0 0 0-.232-.095z" />`,
  mastodon: () => html`<path d="M23.268 5.313c-.35-2.578-2.617-4.61-5.304-5.004C17.51.242 15.792 0 11.813 0h-.03c-3.98 0-4.835.242-5.288.309C3.882.692 1.496 2.518.917 5.127.64 6.412.61 7.837.661 9.143c.074 1.874.088 3.745.26 5.611.118 1.24.325 2.47.62 3.68.55 2.237 2.777 4.098 4.96 4.857 2.336.792 4.849.923 7.256.38.265-.061.527-.132.786-.213.585-.184 1.27-.39 1.774-.753a.057.057 0 0 0 .023-.043v-1.809a.052.052 0 0 0-.02-.041.053.053 0 0 0-.046-.01 20.282 20.282 0 0 1-4.709.545c-2.73 0-3.463-1.284-3.674-1.818a5.593 5.593 0 0 1-.319-1.433.053.053 0 0 1 .066-.054c1.517.363 3.072.546 4.632.546.376 0 .75 0 1.125-.01 1.57-.044 3.224-.124 4.768-.422.038-.008.077-.015.11-.024 2.435-.464 4.753-1.92 4.989-5.604.008-.145.03-1.52.03-1.67.002-.512.167-3.63-.024-5.545zm-3.748 9.195h-2.561V8.29c0-1.309-.55-1.976-1.67-1.976-1.23 0-1.846.79-1.846 2.35v3.403h-2.546V8.663c0-1.56-.617-2.35-1.848-2.35-1.112 0-1.668.668-1.67 1.977v6.218H4.822V8.102c0-1.31.337-2.35 1.011-3.12.696-.77 1.608-1.164 2.74-1.164 1.311 0 2.302.5 2.962 1.498l.638 1.06.638-1.06c.66-.999 1.65-1.498 2.96-1.498 1.13 0 2.043.395 2.74 1.164.675.77 1.012 1.81 1.012 3.12z" />`,
}
...
export class SocialShareElement extends LitElement {
  ...
  private get selectedPlatforms(): SharePlatform[] {
    ...
    const filterList = requestedNetworks.length > 0 ? requestedNetworks : DEFAULT_NETWORKS.split(',')
  ...
  private renderPlatform(platform: SharePlatform, shareData: ShareData, shareText: string) {
    ...
    if (platform.useModal) {
      ...
      return html`
        ...
        >
          ${icon
            ? html`<svg class="h-4 w-4 fill-current" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
                ${icon}
              </svg>`
            : null}
  ...
  private openMastodonModal(text: string): void {
    ...
    const mastodonModal = (window as Window & { openMastodonModal?: (_text: string) => void }).openMastodonModal
