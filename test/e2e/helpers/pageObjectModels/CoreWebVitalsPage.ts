...
export class CoreWebVitalsPage extends BasePage {
  protected constructor(page: Page) {
    super(page)
  }

  static override async init(page: Page): Promise<CoreWebVitalsPage> {
    await this.setupPlaywrightGlobals(page)
    const instance = new CoreWebVitalsPage(page)
