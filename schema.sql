...
CREATE TABLE IF NOT EXISTS "public"."dsar_requests" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "dsar_requests_request_type_check" CHECK (("request_type" = ANY (ARRAY['ACCESS'::"text", 'DELETE'::"text"])))
);
...
ALTER TABLE ONLY "public"."dsar_requests"
    ADD CONSTRAINT "dsar_requests_token_key" UNIQUE ("token");



ALTER TABLE ONLY "public"."newsletter_confirmations"
    ADD CONSTRAINT "newsletter_confirmations_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."newsletter_confirmations"
    ADD CONSTRAINT "newsletter_confirmations_token_key" UNIQUE ("token");
...
CREATE INDEX "idx_consent_data_subject_id" ON "public"."consent_records" USING "btree" ("data_subject_id");



CREATE INDEX "idx_consent_email" ON "public"."consent_records" USING "btree" ("email") WHERE ("email" IS NOT NULL);



CREATE INDEX "idx_consent_timestamp" ON "public"."consent_records" USING "btree" ("timestamp" DESC);



CREATE INDEX "idx_dsar_expiry" ON "public"."dsar_requests" USING "btree" ("expires_at") WHERE ("fulfilled_at" IS NULL);



CREATE INDEX "idx_dsar_token" ON "public"."dsar_requests" USING "btree" ("token");



CREATE INDEX "idx_newsletter_expiry" ON "public"."newsletter_confirmations" USING "btree" ("expires_at") WHERE ("confirmed_at" IS NULL);



CREATE INDEX "idx_newsletter_token" ON "public"."newsletter_confirmations" USING "btree" ("token");
...
CREATE POLICY "service_role_all_access" ON "public"."consent_records" TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "service_role_all_access" ON "public"."dsar_requests" TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "service_role_all_access" ON "public"."newsletter_confirmations" TO "service_role" USING (true) WITH CHECK (true);
...
GRANT ALL ON TABLE "public"."dsar_requests" TO "anon";
GRANT ALL ON TABLE "public"."dsar_requests" TO "authenticated";
GRANT ALL ON TABLE "public"."dsar_requests" TO "service_role";



GRANT ALL ON TABLE "public"."newsletter_confirmations" TO "anon";
GRANT ALL ON TABLE "public"."newsletter_confirmations" TO "authenticated";
GRANT ALL ON TABLE "public"."newsletter_confirmations" TO "service_role";
