...
- E2e tests to verify that theme picker modal stays open on navigation
- Modal open/closed state needs to be stored in a nanostore if it should persist
I want to keep the modal open after navigation. I understand the UX issues. I would like to modify this to check the referrer - keep it where the modal open / close state persists across page navigation, and we'll come back this to improve the behavior.

Summary
You have 138 unique skipped tests that appear as 1,019 total skips because they run across ~7 browser configurations (Chromium, Firefox, WebKit, Mobile Chrome, Mobile Safari, etc.).

Breakdown:

@wip (Work In Progress): 91 tests - Ready to implement, just need development time
@blocked (Infrastructure Needed): 44 tests - Need tooling/features first
@flaky (Intermittent): 3 tests - Timing issues with auto-play/rotation
...
The good news: 91 @wip tests can be implemented now with the existing infrastructure!

> ╔══════════════════════════════════════════════════════════════════════════════╗
> ║                    E2E SKIPPED TESTS BREAKDOWN                                ║
> ╠══════════════════════════════════════════════════════════════════════════════╣
> ║                                                                               ║
> ║  UNIQUE SKIPPED TESTS: 138                                                   ║
> ║  TOTAL SKIPS REPORTED: 1,019 (138 × ~7 browser configs)                      ║
> ║  PASSING TESTS:        1,847                                                 ║
> ║                                                                               ║
> ╠══════════════════════════════════════════════════════════════════════════════╣
...
> ╠══════════════════════════════════════════════════════════════════════════════╣
> ║                                                                               ║
> ║  @wip (Work In Progress):     91 tests                                       ║
> ║  @blocked (Blocked/Pending):  44 tests                                       ║
> ║  @flaky (Intermittent):        3 tests                                       ║
> ║                                                                               ║
> ╠══════════════════════════════════════════════════════════════════════════════╣
> ║                    FILES WITH MOST SKIPPED TESTS                              ║
> ╠══════════════════════════════════════════════════════════════════════════════╣
> ║                                                                               ║
> ║  1. cookie-consent.spec.ts           15 @wip tests                           ║
> ║     - Banner visibility and interaction tests                                ║
> ║     - Preference modal tests                                                 ║
> ║     - Persistence and accessibility tests                                    ║
> ║                                                                               ║
> ║  2. social-shares.spec.ts            12 @wip tests                           ║
> ║     - Share button functionality                                             ║
> ║     - Web Share API tests                                                    ║
> ║     - Platform-specific share tests                                          ║
> ║                                                                               ║
> ║  3. testimonials.spec.ts             11 @wip + 2 @flaky                      ║
> ║     - Carousel navigation tests                                              ║
> ║     - Auto-rotation tests (flaky)                                            ║
> ║                                                                               ║
> ║  4. gdpr-consent.spec.ts             10 @wip tests                           ║
> ║     - GDPR checkbox validation                                               ║
> ║     - Form integration tests                                                 ║
> ║                                                                               ║
> ║  5. theme-picker.spec.ts             10 @wip tests                           ║
> ║     - Theme switching tests                                                  ║
> ║     - Preference persistence                                                 ║
> ║                                                                               ║
> ║  6. carousel.spec.ts                  9 @wip + 1 @flaky                      ║
> ║     - Navigation and keyboard tests                                          ║
> ║     - Auto-play tests (flaky)                                                ║
> ║                                                                               ║
> ╠══════════════════════════════════════════════════════════════════════════════╣
...
> ║  - component-rendering.spec.ts       9 @blocked                              ║
> ║  - responsive-layouts.spec.ts        5 @blocked                              ║
> ║  - theme-switching.spec.ts           4 @blocked                              ║
> ║    Reason: Visual regression testing not implemented yet                     ║
> ║                                                                               ║
> ║  PERFORMANCE AUDITS (6 tests):                                               ║
> ║  - lighthouse.spec.ts                6 @blocked                              ║
> ║    Reason: Lighthouse integration pending                                    ║
> ║                                                                               ║
> ║  PWA FUNCTIONALITY (12 tests):                                               ║
> ║  - offline-mode.spec.ts              6 @blocked                              ║
> ║  - service-worker.spec.ts            6 @blocked                              ║
> ║    Reason: PWA features not yet implemented                                  ║
> ║                                                                               ║
> ║  NEWSLETTER FLOW (6 tests):                                                  ║
> ║  - newsletter-double-optin.spec.ts   6 @blocked                              ║
> ║    Reason: Email testing infrastructure needed                               ║
> ║                                                                               ║
> ║  ACCESSIBILITY AUDITS (2 tests):                                             ║
> ║  - axe.spec.ts                       2 @blocked                              ║
> ║    Reason: Axe-core integration pending                                      ║
> ║                                                                               ║
> ╠══════════════════════════════════════════════════════════════════════════════╣
> ║                    RECOMMENDATIONS                                            ║
> ╠══════════════════════════════════════════════════════════════════════════════╣
> ║                                                                               ║
> ║  Priority 1 - Quick Wins (@wip):                                             ║
> ║  ✓ cookie-consent.spec.ts - 15 tests can be implemented                     ║
> ║  ✓ social-shares.spec.ts  - 12 tests can be implemented                     ║
> ║  ✓ gdpr-consent.spec.ts   - 10 tests can be implemented                     ║
> ║                                                                               ║
> ║  Priority 2 - Flaky Tests (3 tests):                                         ║
> ║  ⚠ Fix carousel auto-play test                                               ║
> ║  ⚠ Fix testimonials auto-rotation tests                                      ║
> ║                                                                               ║
> ║  Priority 3 - Infrastructure Needed (@blocked):                              ║
> ║  • Visual regression tooling (18 tests)                                      ║
> ║  • Lighthouse integration (6 tests)                                          ║
> ║  • PWA implementation (12 tests)                                             ║
> ║  • Email testing setup (6 tests)                                             ║
